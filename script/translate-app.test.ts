...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".swiftcoder/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".swiftcoder/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".swiftcoder/glossary/zh-tw.md")
  })
