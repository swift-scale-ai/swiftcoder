...
export const SwiftCoderEvent = event.schema
export type SwiftCoderEvent = typeof SwiftCoderEvent.Type
export type SwiftCoderEventEncoded = typeof SwiftCoderEvent.Encoded
