...
import { registerSwiftCoderTheme } from "@opencode-ai/ui/context/marked-theme-register"

registerSwiftCoderTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for SwiftCoder, as I think 8 might be
