...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SWIFTCODER_CALLER", () => {
    process.env["SWIFTCODER_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SWIFTCODER_CALLER", () => {
    process.env["SWIFTCODER_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SWIFTCODER_CALLER", () => {
    process.env["SWIFTCODER_CALLER"] = "unknown"
