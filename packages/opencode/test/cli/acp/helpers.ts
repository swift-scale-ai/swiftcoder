...
export function createAcpClient(input: Pick<CliFixture, "swiftcoder">, env?: Record<string, string>) {
  return Effect.gen(function* () {
    return createJsonRpcAcpClient(yield* input.swiftcoder.acp(env ? { env } : undefined))
  })
}
