...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://swift-scale.com/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://swift-scale.com/s/Jsj3hNIW")).toBeNull()
  expect(parseShareUrl("https://swift-scale.com/share/")).toBeNull()
  expect(parseShareUrl("https://swift-scale.com/share/id/extra")).toBeNull()
