...
import { makeGlobalNode } from "@swiftscale/core/effect/app-node"
...
import { InstallationChannel } from "@swiftscale/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("swiftcoder")) return "swiftcoder"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("anomalyco/tap/opencode") && args.includes("--formula")) return "swiftcoder"
