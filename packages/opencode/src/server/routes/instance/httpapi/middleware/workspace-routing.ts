...
>()("@swiftcoder/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@swiftcoder/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.SWIFTCODER_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.SWIFTCODER_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-swiftcoder-directory"] || process.cwd()
}
