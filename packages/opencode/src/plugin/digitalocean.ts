...
import type { Model } from "@swiftscale/sdk/v2"
import { InstallationVersion } from "@swiftscale/core/installation/version"
import { OauthCallbackPage } from "@swiftscale/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. SwiftCoder will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
