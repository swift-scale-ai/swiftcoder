...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __SWIFTCODER_PHOTON_WASM_PATH?: string }).__SWIFTCODER_PHOTON_WASM_PATH =
