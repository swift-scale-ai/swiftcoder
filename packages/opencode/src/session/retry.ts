...
export const USAGE_UPGRADE_MESSAGE = "Free usage exceeded, upgrade SwiftCoder"
export const USAGE_UPGRADE_URL = "https://swift-scale.com/account/usage"
...
export function retryable(error: Err, provider: string) {
  ...
  if (SessionV1.APIError.isInstance(error)) {
    ...
    if (error.data.responseBody?.includes("GoUsageLimitError")) {
      ...
      const link = `https://swift-scale.com/workspace/${workspace}/usage`
      return {
