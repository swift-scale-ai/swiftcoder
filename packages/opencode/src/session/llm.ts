...
import { llmClient } from "@swiftscale/core/effect/app-node-platform"
...
import type { LLMEvent } from "@swiftscale/llm"
import { LLMClient } from "@swiftscale/llm/route"
import type { LLMClientService } from "@swiftscale/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via swiftcoder's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @swiftscale/llm. It
