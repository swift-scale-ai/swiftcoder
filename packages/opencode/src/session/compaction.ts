...
import { buildPrompt } from "@swiftscale/core/session/compaction"
import { SessionCompactionEvent } from "@swiftscale/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/SessionCompaction") {}
