import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@swiftscale/llm"
...
// Move this extraction into @swiftscale/llm when Copilot is handled by the native runtime.
