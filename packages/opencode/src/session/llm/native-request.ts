import type { JsonSchema, LLMRequest, ProviderMetadata } from "@swiftscale/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@swiftscale/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @swiftscale/llm request objects from swiftcoder's session/AI SDK-shaped data.
  return LLM.request({
