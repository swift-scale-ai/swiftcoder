...
import { MAX_STEPS_PROMPT } from "@swiftscale/core/session/runner/max-steps"
...
import { LLMEvent } from "@swiftscale/llm"
...
export const shouldReuseModelForTitle = (modelID: ModelV2.ID) => modelID === ModelV2.ID.make("swiftlite.auto")
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/SessionPrompt") {}
  ...
  Effect.gen(function* () {
    ...
    const title = Effect.fn("SessionPrompt.ensureTitle")(function* (input: {
      ...
      const mdl = ag.model
        ...
        : shouldReuseModelForTitle(input.modelID)
