...
import { Usage, type LLMEvent } from "@swiftscale/llm"
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/SessionProcessor") {}
          ...
          yield* Effect.gen(function* () {
            ...
            Effect.retry(
              SessionRetry.policy({
                ...
                parse,
                // Retrying after text or a tool call has been observed can duplicate
                // output and side effects. Preserve the partial turn and let the user
                // explicitly retry from the durable session instead.
                canRetry: () => !receivedStreamEvent,
                set: (info) => {
