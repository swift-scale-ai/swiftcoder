 ...
 *   "@swiftcoder/ServerAuthConfig",
 *   {
 *     password: Config.string("SWIFTCODER_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SWIFTCODER_SERVER_USERNAME").pipe(Config.withDefault("swiftcoder")),
 *   },
 * ) {}
 *
