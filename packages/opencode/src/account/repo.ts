...
import { AccountStateTable, AccountTable } from "@swiftscale/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/AccountRepo") {}
