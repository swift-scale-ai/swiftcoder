...
import type { Event, GlobalEvent, SwiftCoderClient } from "@opencode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@swiftcoder/RunStreamTransport") {}
