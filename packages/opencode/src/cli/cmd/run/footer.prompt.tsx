...
import { normalizePromptContent } from "@swiftscale/coder-tui/editor"
...
import { SWIFTCODER_BASE_MODE, useBindings } from "@swiftscale/coder-tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close SwiftCoder" } satisfies SlashOption,
    ]
