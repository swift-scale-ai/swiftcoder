...
import { openEditor } from "@swiftscale/coder-tui/editor"
import { registerSwiftCoderKeymap } from "@swiftscale/coder-tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerSwiftCoderKeymap(keymap, renderer, input.tuiConfig)
