...
import { ProjectDirectoryTable, ProjectTable } from "@swiftscale/core/project/sql"
import { ProjectDirectories } from "@swiftscale/core/project/directories"
...
import { which } from "@swiftscale/core/util/which"
...
import { Project } from "@swiftscale/schema/project"
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.SWIFTCODER_FAKE_VCS)
