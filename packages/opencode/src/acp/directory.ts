...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@swiftcoder/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@swiftcoder/ACPDirectory") {}
