...
import type { AssistantMessage as SwiftCoderAssistantMessage, Message } from "@swiftscale/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@swiftscale/core/effect/app-node"
...
export type AssistantTokenCost = Pick<SwiftCoderAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<SwiftCoderAssistantMessage, "role"> &
  Partial<Pick<SwiftCoderAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@swiftcoder/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@swiftcoder/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@swiftcoder/ACPUsage") {}
