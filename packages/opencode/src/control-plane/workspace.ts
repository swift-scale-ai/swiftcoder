...
import { EventSequenceTable, EventTable } from "@swiftscale/core/event/sql"
...
import { WorkspaceEvent } from "@swiftscale/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SWIFTCODER_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        SWIFTCODER_WORKSPACE_ID: config.id,
        SWIFTCODER_EXPERIMENTAL_WORKSPACES: "true",
