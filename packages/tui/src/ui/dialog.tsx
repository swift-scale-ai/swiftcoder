...
import { useBindings, useSwiftCoderModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useSwiftCoderModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.SWIFTCODER_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
