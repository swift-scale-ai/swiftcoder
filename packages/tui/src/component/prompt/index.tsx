...
import { registerSwiftCoderSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@swiftscale/sdk/v2"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.SWIFTCODER_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
