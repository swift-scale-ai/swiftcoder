...
import defaultSoundPath from "@swiftscale/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@swiftscale/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@swiftscale/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@swiftscale/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@swiftscale/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@swiftscale/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "swiftcoder"
const DEFAULT_PACK_ID = "swiftcoder.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "SwiftCoder Default",
  builtin: true,
  sounds: {
