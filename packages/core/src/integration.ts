...
export interface KeyImplementation {
  ...
  readonly connect?: (key: string) => Effect.Effect<Credential.Key, unknown>
}
...
type Entry = {
  ...
  keyImplementation?: Types.DeepMutable<KeyImplementation>
}
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/v2/Integration") {}
        ...
        method: {
          ...
          update: (implementation) => {
            ...
            if (implementation.method.type === "key") {
              current.keyImplementation = implementation as Types.DeepMutable<KeyImplementation>
            }
          },
          remove: (integrationID, method) => {
            ...
            if (method.type === "key") current.keyImplementation = undefined
          },
        },
      }),
    ...
    return Service.of({
      ...
      connection: {
        ...
        key: Effect.fn("Integration.connection.key")(function* (input) {
          ...
          const value = entry.keyImplementation?.connect
            ? yield* authorize(entry.keyImplementation.connect(input.key))
