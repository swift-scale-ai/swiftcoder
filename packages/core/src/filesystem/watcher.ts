...
declare const SWIFTCODER_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof SWIFTCODER_LIBC === "undefined" ? undefined : SWIFTCODER_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.SWIFTCODER_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.SWIFTCODER_EXPERIMENTAL_FILEWATCHER)) {
