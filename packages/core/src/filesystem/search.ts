...
export class Service extends Context.Service<Service, Interface>()("@swiftcoder/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.SWIFTCODER_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
