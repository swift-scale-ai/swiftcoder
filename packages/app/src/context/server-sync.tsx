...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: SwiftCoderClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  serverAPI: ServerApi,
  sdkFor: (dir: PathKey) => SwiftCoderClient,
  protocol: Promise<"v1" | "v2">,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, SwiftCoderClient>()
