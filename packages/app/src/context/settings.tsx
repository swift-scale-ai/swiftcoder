...
export const { use: useSettings, provider: SettingsProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    let productAnalyticsSynced = false
    ...
    createEffect(() => {
      if (!ready() || productAnalyticsSynced || !platform.productAnalytics) return
      productAnalyticsSynced = true
      void platform.productAnalytics.setEnabled(store.general?.productAnalytics === true)
    })
    ...
    return {
      ...
      general: {
        ...
        productAnalytics: withFallback(() => store.general?.productAnalytics, false),
        setProductAnalytics(value: boolean) {
          setStore("general", "productAnalytics", value)
          void platform.productAnalytics?.setEnabled(value)
        },
