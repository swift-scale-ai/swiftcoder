...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://swift-scale.com/docs" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://swift-scale.com/community" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://swift-scale.com/support/swiftcoder?type=feature",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://swift-scale.com/support/swiftcoder?type=bug",
      },
    ],
  },
]
