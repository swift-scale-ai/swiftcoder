export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno SwiftCoder se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "SwiftCoder se ne odziva",
  ...
  "desktop.wsl.error.installSwiftCoder": "Namestitev SwiftCoder ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder ni nameščen v tej distribuciji",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev SwiftCoder je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.swiftcoder.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.swiftcoderGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Obisk ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v SwiftCoder.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v swiftcoder.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom SwiftCoder se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Preverjanje SwiftCoder ...",
  "wsl.onboarding.checkingSwiftCoderIn": "Preverjanje SwiftCoder v {{distro}} ...",
  "wsl.onboarding.updatingSwiftCoder": "Posodabljanje SwiftCoder ...",
  "wsl.onboarding.updatingSwiftCoderIn": "Posodabljanje SwiftCoder v {{distro}} ...",
  "wsl.onboarding.updateSwiftCoderIn": "Posodobite SwiftCoder v {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Posodobite SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder je pripravljen v {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder je pripravljen.",
  "wsl.onboarding.installSwiftCoderIn": "Namestite SwiftCoder v {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Namestite SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko SwiftCoder doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica SwiftCoder ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi SwiftCoder",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (swiftcoder.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, SwiftCoder še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik SwiftCoder znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako SwiftCoder izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali SwiftCoder sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico SwiftCoder.",
