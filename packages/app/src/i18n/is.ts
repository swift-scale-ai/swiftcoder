...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða SwiftCoder",
  "SwiftCoder-glugganum var óvænt lokað",
  "SwiftCoder svarar ekki",
  ...
  "Uppsetning SwiftCoder mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "swiftcoder er ekki uppsett í þessari dreifingu",
  "swiftcoder er uppsett en ekki var hægt að keyra það",
  "SwiftCoder er ekki uppsett í {{distro}}",
  "Uppfærslu SwiftCoder lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.swiftcoder.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.swiftcoderGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.swiftcoderZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.swiftcoderZen.visit.prefix": "Heimsókn",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í SwiftCoder.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í swiftcoder.json",
  ...
  "dialog.server.description": "Skiptu um hvaða SwiftCoder miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Athugar SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Athugar SwiftCoder í {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Uppfærir SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Uppfærir SwiftCoder í {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Uppfærðu SwiftCoder í {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Uppfærðu SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder er tilbúið í {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder er tilbúinn.",
  "wsl.onboarding.installSwiftCoderIn": "Settu upp SwiftCoder í {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Settu upp SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en SwiftCoder getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan SwiftCoder aftur.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af SwiftCoder ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til SwiftCoder teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (swiftcoder.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, SwiftCoder styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "settings.desktop.wsl.description": "Keyrðu SwiftCoder netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig SwiftCoder lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort SwiftCoder fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig SwiftCoder er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar SwiftCoder ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af SwiftCoder.",
