export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder دستاویزات",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder مینو",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "SwiftCoder ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "SwiftCoder جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.swiftcoderMissing": "اس ڈسٹری بیوشن میں swiftcoder انسٹال نہیں ہے",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.swiftcoderNotInstalled": "{{distro}} میں SwiftCoder انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.swiftcoder.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.swiftcoder.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.swiftcoderGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور SwiftCoder میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور SwiftCoder میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور SwiftCoder میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "swiftcoder.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس SwiftCoder سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingSwiftCoderIn": "{{distro}} میں SwiftCoder چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingSwiftCoderIn": "{{distro}} میں SwiftCoder کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateSwiftCoderIn": "{{distro}} میں SwiftCoder کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder {{distro}} میں تیار ہے۔",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder تیار ہے۔",
  "wsl.onboarding.installSwiftCoderIn": "{{distro}} میں SwiftCoder انسٹال کریں۔",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ SwiftCoder WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر SwiftCoder کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم SwiftCoder ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (swiftcoder.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، SwiftCoder ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر SwiftCoder سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "SwiftCoder کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر SwiftCoder کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا SwiftCoder سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "SwiftCoder کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "SwiftCoder لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ SwiftCoder کا تازہ ترین ورژن چلا رہے ہیں۔",
