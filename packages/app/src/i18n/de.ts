...
export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.swiftcoder.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.swiftcoderGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in SwiftCoder zu nutzen.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in SwiftCoder zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in SwiftCoder zu nutzen.",
  ...
  "dialog.plugins.empty": "In swiftcoder.json konfigurierte Plugins",
  ...
  "dialog.server.title": "Agent-Umgebungen",
  "dialog.server.description": "Wählen Sie aus, wo die SwiftCoder Agent Runtime ausgeführt wird.",
  "dialog.server.search.placeholder": "Umgebungen durchsuchen",
  "dialog.server.empty": "Noch keine Remote-Umgebungen",
  "dialog.server.add.title": "Remote-Umgebung hinzufügen",
  "dialog.server.add.url": "URL der Remote-Umgebung",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Verbindung zur Agent Runtime fehlgeschlagen",
  "dialog.server.add.checking": "Prüfen…",
  "dialog.server.add.button": "Remote-Umgebung hinzufügen",
  "dialog.server.add.name": "Umgebungsname (optional)",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "Benutzername (optional)",
  "dialog.server.add.password": "Passwort (optional)",
  "dialog.server.edit.title": "Remote-Umgebung bearbeiten",
  "dialog.server.default.title": "Standardumgebung",
  "dialog.server.default.description":
    "Beim App-Start mit dieser Remote-Umgebung verbinden, anstatt die Agent Runtime auf diesem Mac zu starten. Ein Neustart ist erforderlich.",
  "dialog.server.default.none": "Keine Remote-Umgebung ausgewählt",
  "dialog.server.default.set": "Aktuelle Umgebung als Standard setzen",
  "dialog.server.default.clear": "Löschen",
  "dialog.server.action.remove": "Umgebung entfernen",
  ...
  "dialog.server.current": "Aktuelle Umgebung",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder wird geprüft…",
  "wsl.onboarding.checkingSwiftCoderIn": "SwiftCoder in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder wird aktualisiert…",
  "wsl.onboarding.updatingSwiftCoderIn": "SwiftCoder in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateSwiftCoderIn": "Aktualisieren Sie SwiftCoder in {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder aktualisieren",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder ist in {{distro}} bereit.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder ist bereit.",
  "wsl.onboarding.installSwiftCoderIn": "Installieren Sie SwiftCoder in {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder installieren",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor SwiftCoder einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann SwiftCoder erneut.",
  ...
  "toast.update.description": "Eine neue Version von SwiftCoder ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem SwiftCoder-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (swiftcoder.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: SwiftCoder unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "SwiftCoder mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "status.popover.tab.servers": "Agent-Umgebungen",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für SwiftCoder ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie SwiftCoder auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob SwiftCoder dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von SwiftCoder anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von SwiftCoder automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "SwiftCoder ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von SwiftCoder wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das SwiftCoder-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "SwiftCoder reagiert nicht",
  ...
  "desktop.server.local": "Lokale Agent-Umgebung",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das SwiftCoder-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
