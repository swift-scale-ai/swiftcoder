export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل SwiftCoder",
  "desktop.recovery.terminated": "توقفت نافذة SwiftCoder بشكل غير متوقع",
  "desktop.recovery.unresponsive": "SwiftCoder لا يستجيب",
  ...
  "desktop.wsl.error.installSwiftCoder": "فشل تثبيت SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث SwiftCoder، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.swiftcoder.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.swiftcoderGo.tagline": "اشتراك منخفض التكلفة للجميع",
  "dialog.provider.anthropic.note": "وصول مباشر إلى نماذج Claude، بما فيها Pro و Max",
  "dialog.provider.openswiftscale.note": "بوابة مفتوحة المصدر وذاتية الاستضافة متوافقة مع OpenAI",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "يمنحك SwiftCoder الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "قم بزيارة ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في SwiftCoder.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في swiftcoder.json",
  ...
  "dialog.server.description": "تبديل خادم SwiftCoder الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "جارٍ التحقق من SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "جارٍ التحقق من SwiftCoder في {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "جارٍ تحديث SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "جارٍ تحديث SwiftCoder في {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "حدّث SwiftCoder في {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "تحديث SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder جاهز في {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder جاهز.",
  "wsl.onboarding.installSwiftCoderIn": "ثبّت SwiftCoder في {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "تثبيت SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن SwiftCoder من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على SwiftCoder التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح SwiftCoder.",
  ...
  "help.tabs.introduction": "أصبح SwiftCoder Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من SwiftCoder ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق SwiftCoder",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (swiftcoder.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن SwiftCoder لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن SwiftCoder نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم SwiftCoder داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ SwiftCoder",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور SwiftCoder على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان SwiftCoder يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من SwiftCoder.",
  ...
  "sidebar.projects.empty": "لا توجد مشاريع بعد",
  "sidebar.chat": "الدردشة",
  "sidebar.chat.empty": "لا توجد محادثات بعد",
  "settings.section.swiftscale": "SwiftScaleCloud",
  "settings.tab.accountPlan": "الحساب والخطة",
  "settings.account.title": "الحساب",
  "settings.account.desktopOnly": "تسجيل الدخول إلى الحساب متاح في تطبيق macOS.",
  "settings.account.swiftScaleAccount": "حساب SwiftScaleCloud",
  "settings.account.signIn.authorizing": "أكمل تسجيل الدخول في المتصفح. سيواصل SwiftCoder تلقائيًا.",
  "settings.account.signIn.description": "سجّل الدخول لاستخدام النماذج المضمنة في حسابك.",
  "settings.account.signIn.action": "تسجيل الدخول",
  "settings.account.productAccess.title": "الوصول إلى المنتجات",
  "settings.account.productAccess.description": "منتجات SwiftScale المفعّلة لهذا الحساب",
  "settings.account.plan.title": "الخطة",
  "settings.account.plan.accountPayg": "حساب {{tier}} - الدفع حسب الاستخدام",
  "settings.account.plan.subscription": "اشتراك {{status}}",
  "settings.account.plan.subscriptionWithApi": "{{subscription}} - خدمات API بنظام الدفع حسب الاستخدام مفعّلة",
  "settings.account.refresh": "تحديث",
  "settings.account.reset.none": "لم يتم توفير تاريخ إعادة التعيين",
  "settings.account.reset.unavailable": "تاريخ إعادة التعيين غير متاح",
  "settings.account.reset.at": "تتم إعادة التعيين في {{date}}",
  "settings.account.usage.title": "الاستخدام",
  "settings.account.usage.available": "متاح",
  "settings.account.usage.limited": "محدود",
  "settings.account.usage.exhausted": "مستنفد",
  "settings.account.capacity.title": "السعة المضمنة",
  "settings.account.capacity.context": "سياق {{tier}}",
  "settings.account.capacity.tasks": "{{count}} مهام متزامنة",
  "settings.account.capacity.unlimited": "لا يوجد حد ثابت للتزامن",
  "settings.account.capacity.codingPlan": "حد التزامن للبرمجة",
  "settings.account.capacity.codingDescription": "سياق {{context}} لكل مهمة",
  "settings.account.capacity.apiServices": "حد التزامن لخدمات API",
  "settings.account.capacity.apiDescription": "الحد الأقصى للمهام المتزامنة في هذه الخطة",
  "settings.account.context.standard": "قياسي",
  "settings.account.context.extended": "موسّع",
  "settings.account.context.maximum": "الحد الأقصى",
  "settings.account.subscription.active": "نشط",
  "settings.account.subscription.pastDue": "متأخر الدفع",
  "settings.account.subscription.canceled": "ملغى",
  "settings.account.billing.title": "الفوترة",
  "settings.account.billing.description": "تتم الفوترة حسب الرموز المستخدمة",
  "settings.account.billing.payg": "الدفع حسب الاستخدام",
  "settings.account.models.title": "الوصول إلى النماذج",
  "settings.account.models.accountAccess": "يستخدم حسابك المسجّل دخوله",
  "settings.account.models.catalog": "كتالوج SwiftScale API",
  "settings.account.service.title": "الخدمة: {{status}}",
  "settings.account.service.operational": "تعمل بشكل طبيعي",
  "settings.account.service.degraded": "أداء متراجع",
  "settings.account.service.unavailable": "غير متاحة",
  "settings.account.service.requestId": "معرّف الطلب: {{requestId}}",
  "settings.account.service.status": "الحالة",
  "settings.account.service.support": "الدعم",
  "settings.account.actions.title": "إجراءات الحساب",
  "settings.account.actions.description": "إدارة اشتراكك أو تسجيل الخروج",
  "settings.account.actions.signOut": "تسجيل الخروج",
  "settings.account.actions.viewPlans": "عرض الخطط",
  "settings.account.actions.manageBilling": "إدارة الفوترة",
  "settings.account.error.planDetails": "تعذّر تحميل تفاصيل خطة SwiftScale",
  "settings.account.error.authentication": "فشلت مصادقة SwiftScale",
  "settings.general.section.supportPrivacy": "الدعم والخصوصية",
  "settings.support.action.open": "فتح",
  "settings.support.privacy.title": "سياسة الخصوصية",
  "settings.support.privacy.description": "راجع كيفية تعامل SwiftCoder وSwiftScale مع بيانات المنتج والحساب.",
  "settings.support.licenses.title": "تراخيص المصادر المفتوحة",
  "settings.support.licenses.description": "راجع إشعارات وتراخيص برامج الجهات الخارجية.",
  "settings.support.diagnostics.title": "حزمة التشخيص",
  "settings.support.diagnostics.description": "صدّر سجلات منقحة لآخر 24 ساعة. لا يتم تضمين الشفرة المصدرية أو محتوى المطالبات.",
  "settings.support.diagnostics.action": "تصدير التشخيصات",
  "settings.support.diagnostics.exported.title": "تم تصدير التشخيصات",
  "settings.support.diagnostics.exported.description": "تم الحفظ في {{path}}",
  "settings.support.deleteData.title": "حذف البيانات المحلية",
  "settings.support.deleteData.description": "احذف الجلسات والإعدادات والسجلات وذاكرة التخزين المؤقت والمسودات وبيانات تسجيل دخول SwiftScale من هذا الـ Mac. سيتم الاحتفاظ بملفات المشاريع.",
  "settings.support.deleteData.action": "حذف البيانات المحلية",
  "settings.providers.connected.accountDescription": "متصل",
  "settings.providers.tag.account": "الحساب",
}
