export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "Không tải được SwiftCoder",
  "desktop.recovery.terminated": "Cửa sổ SwiftCoder đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "SwiftCoder không phản hồi",
  ...
  "desktop.wsl.error.installSwiftCoder": "Không cài đặt được SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật SwiftCoder nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.swiftcoder.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.swiftcoderGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do SwiftCoder cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Truy cập ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong SwiftCoder.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong swiftcoder.json",
  ...
  "dialog.server.description": "Chuyển máy chủ SwiftCoder mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Đang kiểm tra SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Đang kiểm tra SwiftCoder trong {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Đang cập nhật SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Đang cập nhật SwiftCoder trong {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Cập nhật SwiftCoder trong {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Cập nhật SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder đã sẵn sàng.",
  "wsl.onboarding.installSwiftCoderIn": "Cài đặt SwiftCoder trong {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Cài đặt SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi SwiftCoder có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của SwiftCoder ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm SwiftCoder",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (swiftcoder.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: SwiftCoder chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ SwiftCoder bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của SwiftCoder trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem SwiftCoder tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi SwiftCoder khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của SwiftCoder.",
