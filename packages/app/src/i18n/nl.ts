export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder-documentatie",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder kan niet worden geladen",
  "desktop.recovery.terminated": "Het SwiftCoder-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "SwiftCoder reageert niet",
  ...
  "desktop.wsl.error.installSwiftCoder": "Installatie van SwiftCoder is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De SwiftCoder-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.swiftcoder.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.swiftcoderGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in SwiftCoder te gebruiken.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Ga naar ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in SwiftCoder te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in SwiftCoder te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in swiftcoder.json",
  ...
  "dialog.server.description": "Wijzig met welke SwiftCoder-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder controleren...",
  "wsl.onboarding.checkingSwiftCoderIn": "SwiftCoder controleren in {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder bijwerken...",
  "wsl.onboarding.updatingSwiftCoderIn": "SwiftCoder bijwerken in {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Werk SwiftCoder bij in {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder bijwerken",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder is gereed in {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder is klaar.",
  "wsl.onboarding.installSwiftCoderIn": "Installeer SwiftCoder in {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Installeer SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat SwiftCoder een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens SwiftCoder opnieuw.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van SwiftCoder ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het SwiftCoder-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (swiftcoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: SwiftCoder ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de SwiftCoder-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe SwiftCoder eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of SwiftCoder het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van SwiftCoder aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer SwiftCoder wordt gestart",
  ...
  "settings.updates.toast.latest.title": "SwiftCoder is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van SwiftCoder.",
