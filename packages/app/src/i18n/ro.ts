export const dict = {
  ...
  "desktop.menu.documentation": "Documentație SwiftCoder",
  ...
  "desktop.menu.ariaLabel": "Meniu SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra SwiftCoder s-a închis neașteptat",
  "desktop.recovery.unresponsive": "SwiftCoder nu răspunde",
  ...
  "desktop.wsl.error.installSwiftCoder": "Instalarea SwiftCoder a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder nu este instalat în această distribuție",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea SwiftCoder s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.swiftcoder.tagline": "Modele optimizate, fiabile",
  "dialog.provider.swiftcoderGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.swiftcoderZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.swiftcoderZen.visit.prefix": "Vizitează",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în SwiftCoder.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în swiftcoder.json",
  ...
  "dialog.server.description": "Schimbă serverul SwiftCoder la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Se verifică SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Se verifică SwiftCoder în {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Se actualizează SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Se actualizează SwiftCoder în {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Actualizează SwiftCoder în {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Actualizează SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder este gata în {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder este gata.",
  "wsl.onboarding.installSwiftCoderIn": "Instalează SwiftCoder în {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instalează SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca SwiftCoder să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune SwiftCoder ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei SwiftCoder",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (swiftcoder.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, SwiftCoder nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul SwiftCoder în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul SwiftCoder pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă SwiftCoder urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune SwiftCoder.",
