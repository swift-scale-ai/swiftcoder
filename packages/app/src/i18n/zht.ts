...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder 載入失敗",
  "desktop.recovery.terminated": "SwiftCoder 視窗意外終止",
  "desktop.recovery.unresponsive": "SwiftCoder 沒有回應",
  ...
  "desktop.server.local": "本機 Agent 執行環境",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.swiftcoderMissing": "此發行版中未安裝 swiftcoder",
  "desktop.wsl.error.swiftcoderCannotRun": "已安裝 swiftcoder，但無法執行",
  "desktop.wsl.error.swiftcoderNotInstalled": "{{distro}} 中未安裝 SwiftCoder",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.swiftcoder.tagline": "經過最佳化的可靠模型",
  "dialog.provider.swiftcoderGo.tagline": "適合所有人的低成本訂閱",
  "dialog.provider.anthropic.note": "直接存取 Claude 模型，包括 Pro 和 Max",
  "dialog.provider.openswiftscale.note": "開源、可自行托管的 OpenAI 相容網關",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 SwiftCoder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.swiftcoderZen.line1": "SwiftCoder 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.swiftcoderZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.swiftcoderZen.visit.prefix": "造訪 ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 SwiftCoder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 SwiftCoder 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 swiftcoder.json 中設定的外掛程式",
  ...
  "dialog.server.title": "Agent 執行環境",
  "dialog.server.description": "選擇 SwiftCoder Agent Runtime 的執行位置。",
  "dialog.server.search.placeholder": "搜尋執行環境",
  "dialog.server.empty": "尚無遠端環境",
  "dialog.server.add.title": "新增遠端環境",
  "dialog.server.add.url": "遠端環境 URL",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "無法連線到 Agent Runtime",
  "dialog.server.add.checking": "檢查中...",
  "dialog.server.add.button": "新增遠端環境",
  "dialog.server.add.name": "環境名稱（選填）",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "使用者名稱（選填）",
  "dialog.server.add.password": "密碼（選填）",
  "dialog.server.edit.title": "編輯遠端環境",
  "dialog.server.default.title": "預設執行環境",
  "dialog.server.default.description": "應用程式啟動時連線此遠端環境，而不是在本機啟動 Agent Runtime。需要重新啟動。",
  "dialog.server.default.none": "未選擇遠端環境",
  "dialog.server.default.set": "將目前環境設為預設",
  "dialog.server.default.clear": "清除",
  "dialog.server.action.remove": "移除環境",
  ...
  "wsl.onboarding.checkingSwiftCoder": "正在檢查 SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "正在檢查 {{distro}} 中的 SwiftCoder...",
  ...
  "wsl.onboarding.swiftcoderReadyIn": "{{distro}} 中的 SwiftCoder 已就緒。",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder 已就緒。",
  "wsl.onboarding.installSwiftCoderIn": "在 {{distro}} 中安裝 SwiftCoder。",
  "wsl.onboarding.installSwiftCoder": "安裝 SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "未安裝 SwiftCoder",
  ...
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 SwiftCoder。",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 SwiftCoder 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (swiftcoder.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：SwiftCoder 尚不支援 MCP 驗證。",
  ...
  "status.popover.tab.servers": "Agent 執行環境",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder 提供免費模型，你可以立即開始使用。",
  ...
  "settings.tab.accountPlan": "帳號與方案",
  "settings.account.title": "帳號",
  "settings.account.desktopOnly": "帳號登入僅在 macOS App 中可用。",
  "settings.account.swiftScaleAccount": "SwiftScaleCloud 帳號",
  "settings.account.signIn.authorizing": "請在瀏覽器中完成登入，SwiftCoder 將自動繼續。",
  "settings.account.signIn.description": "登入後即可使用帳號方案包含的模型。",
  "settings.account.signIn.action": "登入",
  "settings.account.productAccess.title": "產品權限",
  "settings.account.productAccess.description": "此帳號已啟用的 SwiftScale 產品",
  "settings.account.plan.title": "方案",
  "settings.account.plan.accountPayg": "{{tier}} 帳號 - 按量付費",
  "settings.account.plan.subscription": "{{status}}訂閱",
  "settings.account.plan.subscriptionWithApi": "{{subscription}} - 已啟用 API Services 按量付費",
  "settings.account.refresh": "重新整理",
  "settings.account.reset.none": "暫無重設日期",
  "settings.account.reset.unavailable": "重設日期無法使用",
  "settings.account.reset.at": "重設時間：{{date}}",
  "settings.account.usage.title": "用量",
  "settings.account.usage.available": "可用",
  "settings.account.usage.limited": "受限",
  "settings.account.usage.exhausted": "已用盡",
  "settings.account.capacity.title": "方案容量",
  "settings.account.capacity.context": "{{tier}}上下文",
  "settings.account.capacity.tasks": "{{count}} 個並行任務",
  "settings.account.capacity.unlimited": "無固定並行上限",
  "settings.account.capacity.codingPlan": "程式設計並行上限",
  "settings.account.capacity.codingDescription": "每個任務使用{{context}}上下文",
  "settings.account.capacity.apiServices": "API 並行上限",
  "settings.account.capacity.apiDescription": "目前方案可同時執行的任務數量",
  "settings.account.context.standard": "標準",
  "settings.account.context.extended": "擴充",
  ...
  "settings.account.billing.title": "計費",
  "settings.account.billing.description": "按 Token 用量計費",
  "settings.account.billing.payg": "按量付費",
  "settings.account.models.title": "模型權限",
  "settings.account.models.accountAccess": "使用目前登入帳號",
  "settings.account.models.catalog": "SwiftScale API 模型目錄",
  "settings.account.service.title": "服務{{status}}",
  "settings.account.service.operational": "運作正常",
  "settings.account.service.degraded": "效能下降",
  "settings.account.service.unavailable": "無法使用",
  "settings.account.service.requestId": "請求 ID：{{requestId}}",
  "settings.account.service.status": "狀態",
  "settings.account.service.support": "支援",
  "settings.account.actions.title": "帳號操作",
  "settings.account.actions.description": "管理訂閱或登出",
  "settings.account.actions.signOut": "登出",
  "settings.account.actions.viewPlans": "查看方案",
  "settings.account.actions.manageBilling": "管理帳單",
  "settings.account.error.planDetails": "無法載入 SwiftScale 方案詳情",
  "settings.account.error.authentication": "SwiftScale 身分驗證失敗",
  ...
  "settings.general.row.language.description": "變更 SwiftCoder 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 SwiftCoder 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 SwiftCoder 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 SwiftCoder 的主題。",
  ...
  "settings.updates.row.startup.description": "在 SwiftCoder 啟動時自動檢查更新",
