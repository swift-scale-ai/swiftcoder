export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder se nepodařilo načíst",
  "desktop.recovery.terminated": "SwiftCoder okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "SwiftCoder nereaguje",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder není v této distribuci nainstalováno",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.swiftcoder.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.swiftcoderGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Návštěva ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v SwiftCoder.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v swiftcoder.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému SwiftCoder serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Kontrola SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Kontrola SwiftCoder v {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Aktualizace SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Aktualizace SwiftCoder v {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Aktualizace SwiftCoder v {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Aktualizovat SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder je připraveno v {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder je připraven.",
  "wsl.onboarding.installSwiftCoderIn": "Nainstalujte SwiftCoder do {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instalovat SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než SwiftCoder může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze SwiftCoder ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu SwiftCoder",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (swiftcoder.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: SwiftCoder zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server SwiftCoder uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled SwiftCoder na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude SwiftCoder následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi SwiftCoder.",
