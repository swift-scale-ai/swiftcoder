...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder 加载失败",
  "desktop.recovery.terminated": "SwiftCoder 窗口意外终止",
  "desktop.recovery.unresponsive": "SwiftCoder 未响应",
  ...
  "desktop.server.local": "本地 Agent 运行环境",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.swiftcoderMissing": "此发行版中未安装 swiftcoder",
  "desktop.wsl.error.swiftcoderCannotRun": "已安装 swiftcoder，但无法运行",
  "desktop.wsl.error.swiftcoderNotInstalled": "{{distro}} 中未安装 SwiftCoder",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "permission.mode.title": "SwiftCoder 操作应如何获得批准？",
  "permission.mode.ask.title": "需要批准",
  "permission.mode.ask.description": "编辑、运行命令或联网前询问",
  "permission.mode.agent.title": "为我批准",
  "permission.mode.agent.description": "仅在操作可能有风险时询问",
  "permission.mode.full.title": "完全访问",
  "permission.mode.full.description": "允许访问网络和电脑上的所有文件",
  ...
  "dialog.provider.swiftcoder.note": "精选模型，包括 Claude、GPT、Gemini 等",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 SwiftCoder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.swiftcoderZen.line1": "SwiftCoder 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.swiftcoderZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.swiftcoderZen.visit.prefix": "访问 ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 SwiftCoder 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的账户并在 SwiftCoder 中使用 {{provider}} 模型。",
  ...
  "prompt.outputLimit.title": "选择输出上限",
  "prompt.outputLimit.8k": "输出 8K",
  "prompt.outputLimit.16k": "输出 16K",
  "prompt.outputLimit.32k": "输出 32K",
  ...
  "dialog.plugins.empty": "在 swiftcoder.json 中配置的插件",
  ...
  "dialog.server.title": "Agent 运行环境",
  "dialog.server.description": "选择 SwiftCoder Agent Runtime 的运行位置。",
  "dialog.server.search.placeholder": "搜索运行环境",
  "dialog.server.empty": "暂无远程环境",
  "dialog.server.add.title": "添加远程环境",
  "dialog.server.add.url": "远程环境 URL",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "无法连接到 Agent Runtime",
  "dialog.server.add.checking": "检查中...",
  "dialog.server.add.button": "添加远程环境",
  "dialog.server.add.name": "环境名称（可选）",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "用户名（可选）",
  "dialog.server.add.password": "密码（可选）",
  "dialog.server.edit.title": "编辑远程环境",
  "dialog.server.default.title": "默认运行环境",
  "dialog.server.default.description": "应用启动时连接此远程环境，而不是在本机启动 Agent Runtime。需要重启。",
  "dialog.server.default.none": "未选择远程环境",
  "dialog.server.default.set": "将当前环境设为默认",
  "dialog.server.default.clear": "清除",
  "dialog.server.action.remove": "移除环境",
  ...
  "wsl.onboarding.checkingSwiftCoder": "正在检查 SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "正在检查 {{distro}} 中的 SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoder": "正在更新 SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "正在更新 {{distro}} 中的 SwiftCoder...",
  "wsl.onboarding.updateSwiftCoderIn": "更新 {{distro}} 中的 SwiftCoder。",
  "wsl.onboarding.updateSwiftCoder": "更新 SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "{{distro}} 中的 SwiftCoder 已就绪。",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder 已就绪。",
  "wsl.onboarding.installSwiftCoderIn": "在 {{distro}} 中安装 SwiftCoder。",
  "wsl.onboarding.installSwiftCoder": "安装 SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "未安装 SwiftCoder",
  ...
  "wsl.onboarding.wslNotInstalled.description": "SwiftCoder 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 SwiftCoder。",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 SwiftCoder 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (swiftcoder.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：SwiftCoder 暂不支持 MCP 认证。',
  ...
  "status.popover.tab.servers": "Agent 运行环境",
  ...
  "settings.account.productAccess.title": "产品权限",
  "settings.account.productAccess.description": "此账号已开通的 SwiftScale 产品",
  "settings.account.plan.title": "套餐",
  "settings.account.plan.accountPayg": "{{tier}} 账号 - 按量付费",
  "settings.account.plan.subscription": "{{status}}订阅",
  "settings.account.plan.subscriptionWithApi": "{{subscription}} - 已开通 API Services 按量付费",
  "settings.account.refresh": "刷新",
  "settings.account.reset.none": "暂无重置日期",
  "settings.account.reset.unavailable": "重置日期不可用",
  "settings.account.reset.at": "重置时间：{{date}}",
  "settings.account.usage.title": "用量",
  "settings.account.usage.available": "可用",
  "settings.account.usage.limited": "受限",
  "settings.account.usage.exhausted": "已用尽",
  "settings.account.capacity.title": "套餐容量",
  "settings.account.capacity.context": "{{tier}}上下文",
  "settings.account.capacity.tasks": "{{count}} 个并发任务",
  "settings.account.capacity.unlimited": "无固定并发上限",
  "settings.account.capacity.codingPlan": "编程并发上限",
  "settings.account.capacity.codingDescription": "每个任务使用{{context}}上下文",
  "settings.account.capacity.apiServices": "API 并发上限",
  "settings.account.capacity.apiDescription": "当前套餐可同时运行的任务数量",
  "settings.account.context.standard": "标准",
  "settings.account.context.extended": "扩展",
  "settings.account.context.maximum": "最大",
  "settings.account.subscription.active": "有效",
  "settings.account.subscription.pastDue": "逾期",
  "settings.account.subscription.canceled": "已取消",
  "settings.account.billing.title": "计费",
  "settings.account.billing.description": "按 Token 用量计费",
  "settings.account.billing.payg": "按量付费",
  "settings.account.models.title": "模型权限",
  "settings.account.models.accountAccess": "使用当前登录账号",
  "settings.account.models.catalog": "SwiftScale API 模型目录",
  "settings.account.service.title": "服务{{status}}",
  "settings.account.service.operational": "运行正常",
  "settings.account.service.degraded": "性能下降",
  "settings.account.service.unavailable": "不可用",
  "settings.account.service.requestId": "请求 ID：{{requestId}}",
  "settings.account.service.status": "状态",
  "settings.account.service.support": "支持",
  "settings.account.actions.title": "账号操作",
  "settings.account.actions.description": "管理订阅或退出登录",
  "settings.account.actions.signOut": "退出登录",
  "settings.account.actions.viewPlans": "查看套餐",
  "settings.account.actions.manageBilling": "管理账单",
  "settings.account.error.planDetails": "无法加载 SwiftScale 套餐详情",
  "settings.account.error.authentication": "SwiftScale 身份验证失败",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 集成",
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 SwiftCoder 服务器。",
  ...
  "settings.general.section.supportPrivacy": "支持与隐私",
  "settings.support.action.open": "打开",
  "settings.support.privacy.title": "隐私政策",
  "settings.support.privacy.description": "查看 SwiftCoder 和 SwiftScale 如何处理产品及账户数据。",
  "settings.support.licenses.title": "开源许可证",
  "settings.support.licenses.description": "查看第三方软件声明和许可证。",
  "settings.support.diagnostics.title": "诊断包",
  "settings.support.diagnostics.description": "导出最近 24 小时的脱敏日志，不包含源代码和提示词正文。",
  "settings.support.diagnostics.action": "导出诊断",
  "settings.support.diagnostics.exported.title": "诊断包已导出",
  "settings.support.diagnostics.exported.description": "已保存到 {{path}}",
  "settings.support.deleteData.title": "删除本地数据",
  "settings.support.deleteData.description":
    "删除这台 Mac 上的会话、设置、日志、缓存、草稿和 SwiftScale 登录信息，项目文件不会被删除。",
  "settings.support.deleteData.action": "删除本地数据",
  "settings.general.row.language.title": "语言",
  "settings.general.row.language.description": "更改 SwiftCoder 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 SwiftCoder 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 SwiftCoder 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 SwiftCoder 的主题。",
  ...
  "settings.updates.row.startup.description": "在 SwiftCoder 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 SwiftCoder。",
  ...
  "settings.providers.tag.account": "账号",
  ...
  "settings.providers.connected.accountDescription": "已连接",
