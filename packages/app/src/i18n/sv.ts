export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder kunde inte läsas in",
  "desktop.recovery.terminated": "SwiftCoder-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "SwiftCoder svarar inte",
  ...
  "desktop.wsl.error.installSwiftCoder": "Installationen av SwiftCoder misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder är inte installerat i den här distributionen",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder är installerat men kunde inte köras",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.swiftcoder.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.swiftcoder.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.swiftcoderGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Besök ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i SwiftCoder.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i swiftcoder.json",
  ...
  "dialog.server.description": "Växla vilken SwiftCoder-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Kontrollerar SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Kontrollerar SwiftCoder i {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Uppdaterar SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Uppdaterar SwiftCoder i {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Uppdatera SwiftCoder i {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Uppdatera SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder är redo i {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder är redo.",
  "wsl.onboarding.installSwiftCoderIn": "Installera SwiftCoder i {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Installera SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan SwiftCoder kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan SwiftCoder igen.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av SwiftCoder ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till SwiftCoder-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (swiftcoder.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, SwiftCoder stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör SwiftCoder-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Anpassa hur SwiftCoder ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om SwiftCoder följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa SwiftCoders tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när SwiftCoder startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av SwiftCoder.",
