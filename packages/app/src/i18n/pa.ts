export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "SwiftCoder دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "SwiftCoder جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.swiftcoderMissing": "اس ڈسٹرو وچ swiftcoder انسٹال نئیں اے",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.swiftcoderNotInstalled": "{{distro}} وچ SwiftCoder انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.swiftcoder.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.swiftcoder.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.swiftcoderGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے SwiftCoder وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "ویکھو ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے SwiftCoder وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے SwiftCoder وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "swiftcoder.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس SwiftCoder سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder چیک کر رئے آں...",
  "wsl.onboarding.checkingSwiftCoderIn": "{{distro}} چ SwiftCoder دی جانچ پڑتال...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingSwiftCoderIn": "{{distro}} وچ SwiftCoder نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateSwiftCoderIn": "{{distro}} وچ SwiftCoder نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder اپ ڈیٹ کرو",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder {{distro}} چ تیار اے۔",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder تیار اے۔",
  "wsl.onboarding.installSwiftCoderIn": "{{distro}} وچ SwiftCoder انسٹال کرو۔",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SwiftCoder دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر SwiftCoder دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع SwiftCoder ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (swiftcoder.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، SwiftCoder ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر SwiftCoder سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "SwiftCoder لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے SwiftCoder کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا SwiftCoder سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "SwiftCoder نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں SwiftCoder لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی SwiftCoder دا تازہ ترین ورژن چلا رئے او۔",
