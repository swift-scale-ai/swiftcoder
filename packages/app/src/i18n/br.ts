export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do SwiftCoder",
  ...
  "desktop.menu.ariaLabel": "Menu do SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o SwiftCoder",
  "desktop.recovery.terminated": "A janela do SwiftCoder foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O SwiftCoder não está respondendo",
  ...
  "desktop.server.local": "Ambiente local do agente",
  ...
  "desktop.wsl.error.installSwiftCoder": "Falha na instalação do SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.swiftcoderMissing": "O swiftcoder não está instalado nesta distribuição",
  "desktop.wsl.error.swiftcoderCannotRun": "O swiftcoder está instalado, mas não pôde ser executado",
  "desktop.wsl.error.swiftcoderNotInstalled": "O SwiftCoder não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do SwiftCoder foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.swiftcoder.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.swiftcoderGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Visite ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no SwiftCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurados em swiftcoder.json",
  ...
  "dialog.server.title": "Ambientes do agente",
  "dialog.server.description": "Escolha onde o SwiftCoder Agent Runtime será executado.",
  "dialog.server.search.placeholder": "Buscar ambientes",
  "dialog.server.empty": "Nenhum ambiente remoto ainda",
  "dialog.server.add.title": "Adicionar ambiente remoto",
  "dialog.server.add.url": "URL do ambiente remoto",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Não foi possível conectar ao Agent Runtime",
  "dialog.server.add.checking": "Verificando...",
  "dialog.server.add.button": "Adicionar ambiente remoto",
  "dialog.server.add.name": "Nome do ambiente (opcional)",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "Nome de usuário (opcional)",
  "dialog.server.add.password": "Senha (opcional)",
  "dialog.server.edit.title": "Editar ambiente remoto",
  "dialog.server.default.title": "Ambiente padrão",
  "dialog.server.default.description":
    "Conectar a este ambiente remoto ao iniciar o aplicativo em vez de iniciar o Agent Runtime neste Mac. Requer reinicialização.",
  "dialog.server.default.none": "Nenhum ambiente remoto selecionado",
  "dialog.server.default.set": "Definir o ambiente atual como padrão",
  "dialog.server.default.clear": "Limpar",
  "dialog.server.action.remove": "Remover ambiente",
  ...
  "dialog.server.current": "Ambiente atual",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Verificando o SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Verificando o SwiftCoder em {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Atualizando o SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Atualizando o SwiftCoder em {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Atualize o SwiftCoder em {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Atualizar o SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "O SwiftCoder está pronto em {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "O SwiftCoder está pronto.",
  "wsl.onboarding.installSwiftCoderIn": "Instale o SwiftCoder em {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instalar o SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o SwiftCoder possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O SwiftCoder não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o SwiftCoder novamente.",
  ...
  "help.tabs.introduction": "Agora, o SwiftCoder Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do SwiftCoder ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do SwiftCoder",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (swiftcoder.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: SwiftCoder ainda não suporta autenticação MCP.',
  ...
  "status.popover.tab.servers": "Ambientes do agente",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.section.server": "Agente",
  "settings.tab.general": "Geral",
  "settings.tab.shortcuts": "Atalhos",
  "settings.tab.agentEnvironments": "Ambientes",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integração com WSL",
  "settings.desktop.wsl.description": "Executar o servidor SwiftCoder dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Personalize como o SwiftCoder aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o SwiftCoder segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o SwiftCoder é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o SwiftCoder iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do SwiftCoder.",
