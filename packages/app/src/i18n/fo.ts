export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Skjøl",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder valmynd",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder miseydnaðist at heinta",
  "desktop.recovery.terminated": "SwiftCoder vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "SwiftCoder svarar ikki",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder er ikki sett upp í hesi distro",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder er sett upp men kundi ikki koyra",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.swiftcoder.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.swiftcoder.tagline": "Álítandi optimerað modell",
  "dialog.provider.swiftcoderGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.swiftcoderZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.swiftcoderZen.visit.prefix": "Vitja ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í SwiftCoder.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í swiftcoder.json",
  ...
  "dialog.server.description": "Skift hvønn SwiftCoder ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Kanna SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Kanna SwiftCoder í {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Dagføring SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Dagføring SwiftCoder í {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Dagfør SwiftCoder í {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Dagfør SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder er klárt í {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder er klárt.",
  "wsl.onboarding.installSwiftCoderIn": "Set SwiftCoder upp í {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Set upp SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn SwiftCoder kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani SwiftCoder aftur.",
  ...
  "help.tabs.introduction": "SwiftCoder Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av SwiftCoder ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til SwiftCoder toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (swiftcoder.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, SwiftCoder stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "settings.desktop.wsl.description": "Koyr SwiftCoder ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu SwiftCoder sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um SwiftCoder fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu SwiftCoder er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá SwiftCoder byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av SwiftCoder.",
