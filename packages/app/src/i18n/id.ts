export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder gagal dimuat",
  "desktop.recovery.terminated": "Jendela SwiftCoder berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "SwiftCoder tidak merespons",
  ...
  "desktop.wsl.error.installSwiftCoder": "Instalasi SwiftCoder gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder belum terinstal di distro ini",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan SwiftCoder selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.swiftcoder.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.swiftcoderGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di SwiftCoder.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di swiftcoder.json",
  ...
  "dialog.server.description": "Ganti server SwiftCoder mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Memeriksa SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Memeriksa SwiftCoder di {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Memperbarui SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Memperbarui SwiftCoder di {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Perbarui SwiftCoder di {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Perbarui SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder siap di {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder siap.",
  "wsl.onboarding.installSwiftCoderIn": "Instal SwiftCoder di {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instal SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum SwiftCoder dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru SwiftCoder ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim SwiftCoder",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (swiftcoder.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: SwiftCoder belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server SwiftCoder di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan SwiftCoder di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah SwiftCoder mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat SwiftCoder diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru SwiftCoder.",
