...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder yüklenemedi",
  "desktop.recovery.terminated": "SwiftCoder penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "SwiftCoder yanıt vermiyor",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder bu dağıtımda kurulu değil",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.swiftcoder.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.swiftcoderGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve SwiftCoder'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.swiftcoderZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak SwiftCoder'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak SwiftCoder'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler swiftcoder.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi SwiftCoder sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder kontrol ediliyor...",
  "wsl.onboarding.checkingSwiftCoderIn": "{{distro}} içinde SwiftCoder kontrol ediliyor...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder güncelleniyor...",
  "wsl.onboarding.updatingSwiftCoderIn": "{{distro}} içinde SwiftCoder güncelleniyor...",
  "wsl.onboarding.updateSwiftCoderIn": "{{distro}} içindeki SwiftCoder'u güncelleyin.",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder'u güncelle",
  "wsl.onboarding.swiftcoderReadyIn": "{{distro}} içinde SwiftCoder hazır.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder hazır.",
  "wsl.onboarding.installSwiftCoderIn": "SwiftCoder'u {{distro}} içine kurun.",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder'u kur",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SwiftCoder'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından SwiftCoder'u tekrar açın.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı SwiftCoder ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (swiftcoder.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: SwiftCoder henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "SwiftCoder sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "SwiftCoder'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "SwiftCoder'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "SwiftCoder'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "SwiftCoder'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "SwiftCoder başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "SwiftCoder'un en son sürümünü kullanıyorsunuz.",
