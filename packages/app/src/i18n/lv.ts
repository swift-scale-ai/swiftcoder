export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder dokumentācija",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt SwiftCoder",
  "desktop.recovery.terminated": "SwiftCoder logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "SwiftCoder neatbild",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder nav instalēts šajā distribūcijā",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.swiftcoder.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.swiftcoderGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Apmeklējiet",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus SwiftCoder.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti swiftcoder.json",
  ...
  "dialog.server.description": "Mainiet, pie kura SwiftCoder servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Pārbaudu SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Pārbaudu SwiftCoder distribūcijā {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Atjauninu SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Atjauninu SwiftCoder distribūcijā {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Atjauniniet SwiftCoder distribūcijā {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Atjauniniet SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder ir gatavs.",
  "wsl.onboarding.installSwiftCoderIn": "Instalējiet SwiftCoder distribūcijā {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instalējiet SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms SwiftCoder var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet SwiftCoder no jauna.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna SwiftCoder versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu SwiftCoder komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (swiftcoder.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, SwiftCoder vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "settings.desktop.wsl.description": "Palaist SwiftCoder serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt SwiftCoder saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā SwiftCoder izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai SwiftCoder sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet SwiftCoder tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko SwiftCoder versiju.",
