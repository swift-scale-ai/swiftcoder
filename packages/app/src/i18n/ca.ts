export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Documentació",
  ...
  "desktop.menu.ariaLabel": "menú SwiftCoder.",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra SwiftCoder s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "SwiftCoder no respon",
  ...
  "desktop.wsl.error.installSwiftCoder": "La instal·lació de SwiftCoder ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder no està instal·lat en aquesta distribució",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.swiftcoder.tagline": "Models optimitzats fiables",
  "dialog.provider.swiftcoderGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.swiftcoderZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a SwiftCoder.",
  ...
  "dialog.plugins.empty": "Connectors configurats a swiftcoder.json",
  ...
  "dialog.server.description": "Canvia a quin SwiftCoder servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "S'està comprovant SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "S'està registrant SwiftCoder a {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "S'està actualitzant SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "S'està actualitzant SwiftCoder a {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Actualitza SwiftCoder a {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Actualització SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder està llest a {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder està llest.",
  "wsl.onboarding.installSwiftCoderIn": "Instal·leu SwiftCoder a {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instal·la SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que SwiftCoder pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de SwiftCoder ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip SwiftCoder.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (swiftcoder.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que SwiftCoder encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor SwiftCoder dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu SwiftCoder al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si SwiftCoder segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de SwiftCoder.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï SwiftCoder.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de SwiftCoder.",
