export const dict = {
  ...
  "desktop.menu.documentation": "Документація SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити SwiftCoder",
  "desktop.recovery.terminated": "Роботу вікна SwiftCoder несподівано завершено",
  "desktop.recovery.unresponsive": "SwiftCoder не відповідає",
  ...
  "desktop.wsl.error.installSwiftCoder": "Не вдалося встановити SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder встановлено, але його не вдалося запустити",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення SwiftCoder завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.swiftcoder.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.swiftcoderGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Відвідайте ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у SwiftCoder.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в swiftcoder.json",
  ...
  "dialog.server.description": "Перемкніть сервер SwiftCoder, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Перевірка SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Перевірка SwiftCoder у {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Оновлення SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Оновлення SwiftCoder у {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Оновіть SwiftCoder у {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Оновити SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder готовий до роботи у {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder готовий до роботи.",
  "wsl.onboarding.installSwiftCoderIn": "Встановіть SwiftCoder у {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Встановити SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в SwiftCoder потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія SwiftCoder ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді SwiftCoder",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (swiftcoder.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, SwiftCoder ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер SwiftCoder всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд SwiftCoder на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи SwiftCoder використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію SwiftCoder.",
