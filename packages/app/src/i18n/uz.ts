export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder hujjatlari",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder menyusi",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder yuklanmadi",
  "desktop.recovery.terminated": "SwiftCoder oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "SwiftCoder javob bermayapti",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.swiftcoderMissing": "SwiftCoder ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.swiftcoder.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.swiftcoderGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va SwiftCoder’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va SwiftCoder da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va SwiftCoder da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "swiftcoder.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi SwiftCoder serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder tekshirilmoqda...",
  "wsl.onboarding.checkingSwiftCoderIn": "SwiftCoder {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder yangilanmoqda...",
  "wsl.onboarding.updatingSwiftCoderIn": "SwiftCoder {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateSwiftCoderIn": "SwiftCoder-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder-ni yangilang",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder {{distro}} da tayyor.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder tayyor.",
  "wsl.onboarding.installSwiftCoderIn": "SwiftCoder-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SwiftCoder WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra SwiftCoder-ni qayta oching.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida SwiftCoder jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (swiftcoder.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, SwiftCoder hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "SwiftCoder bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi SwiftCoder serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "SwiftCoder uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "SwiftCoder qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "SwiftCoder tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "SwiftCoder mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "SwiftCoder ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz SwiftCoder oxirgi versiyasini ishga tushiryapsiz.",
