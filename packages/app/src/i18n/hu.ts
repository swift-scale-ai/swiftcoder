...
const desktop = [
  ...
  "Kilépés",
  "Az SwiftCoder betöltése sikertelen",
  "Az SwiftCoder ablaka váratlanul leállt",
  "Az SwiftCoder nem válaszol",
  ...
  "Az SwiftCoder telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az swiftcoder nincs telepítve ebben a disztribúcióban",
  "Az swiftcoder telepítve van, de nem futtatható",
  "Az SwiftCoder nincs telepítve ebben: {{distro}}",
  "Az SwiftCoder frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.swiftcoder.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.swiftcoderGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A SwiftCoder ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a SwiftCoder-ben.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "A SwiftCoder hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Látogatás",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a SwiftCoder-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a SwiftCoder-ben.",
  ...
  "dialog.plugins.empty": "Az swiftcoder.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik SwiftCoder szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder ellenőrzése...",
  "wsl.onboarding.checkingSwiftCoderIn": "SwiftCoder ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder frissítése...",
  "wsl.onboarding.updatingSwiftCoderIn": "SwiftCoder frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateSwiftCoderIn": "Frissítse a SwiftCoder-t a {{distro}}-ben.",
  "wsl.onboarding.updateSwiftCoder": "Frissítse a SwiftCoder-t",
  "wsl.onboarding.swiftcoderReadyIn": "A SwiftCoder készen áll a {{distro}}-ben.",
  "wsl.onboarding.swiftcoderReady": "A SwiftCoder készen áll.",
  "wsl.onboarding.installSwiftCoderIn": "Telepítse a SwiftCoder-t a {{distro}}-be.",
  "wsl.onboarding.installSwiftCoder": "Telepítse a SwiftCoder-t",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "A SwiftCoder nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a SwiftCoder hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A SwiftCoder nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a SwiftCoder programot.",
  ...
  "help.tabs.introduction": "A SwiftCoder Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A SwiftCoder ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a SwiftCoder csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (swiftcoder.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a SwiftCoder még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A SwiftCoder ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "settings.desktop.wsl.description": "Futtassa a SwiftCoder szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a SwiftCoder kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a SwiftCoder az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a SwiftCoder a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a SwiftCoder témáját.",
  ...
  "settings.updates.row.startup.description": "A SwiftCoder indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a SwiftCoder legújabb verzióját futtatja.",
