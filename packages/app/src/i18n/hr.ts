...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "SwiftCoder se nije uspio učitati",
  "Prozor aplikacije SwiftCoder neočekivano je zatvoren",
  "SwiftCoder ne reagira",
  ...
  "Instalacija aplikacije SwiftCoder nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "swiftcoder nije instaliran u ovoj distribuciji",
  "swiftcoder je instaliran, ali se ne može pokrenuti",
  "SwiftCoder nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije SwiftCoder je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.swiftcoder.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.swiftcoderGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Posjetiti",
  "provider.connect.swiftcoderZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.swiftcoderZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u SwiftCoder.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u swiftcoder.json",
  ...
  "dialog.server.description": "Promijenite na koji se SwiftCoder poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingSwiftCoderIn": "Provjera SwiftCoder u {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Ažuriranje SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Ažuriranje SwiftCoder u {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Ažurirajte SwiftCoder u {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Ažurirajte SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder je spreman u {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder je spreman.",
  "wsl.onboarding.installSwiftCoderIn": "Instalirajte SwiftCoder u {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instalirajte SwiftCoder",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što SwiftCoder može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite SwiftCoder.",
  ...
  "help.tabs.introduction": "Radna površina SwiftCoder sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija SwiftCoder ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku SwiftCoder timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (swiftcoder.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, SwiftCoder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder uključuje besplatne modele tako da možete odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokrenite SwiftCoder poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako SwiftCoder izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li SwiftCoder slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je SwiftCoder tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se SwiftCoder pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju SwiftCoder.",
