export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder մենյու",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "SwiftCoder պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "SwiftCoder-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.swiftcoder.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.swiftcoderGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և SwiftCoder-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Այցելություն ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և SwiftCoder-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և SwiftCoder-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են swiftcoder.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ SwiftCoder սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Ստուգում է SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Ստուգում է SwiftCoder-ը {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Թարմացվում է SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Թարմացվում է SwiftCoder-ը {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Թարմացնել SwiftCoder-ը {{distro}}-ում։",
  "wsl.onboarding.updateSwiftCoder": "Թարմացնել SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder պատրաստ է։",
  "wsl.onboarding.installSwiftCoderIn": "Տեղադրեք SwiftCoder-ը {{distro}}-ում։",
  "wsl.onboarding.installSwiftCoder": "Տեղադրեք SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի SwiftCoder-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք SwiftCoder։",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին SwiftCoder թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (swiftcoder.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ SwiftCoder-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք SwiftCoder սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է SwiftCoder տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ SwiftCoder-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է SwiftCoder-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ SwiftCoder-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք SwiftCoder-ի վերջին տարբերակը։",
