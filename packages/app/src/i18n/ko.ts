export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.swiftcoder.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.swiftcoderGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 SwiftCoder에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  "provider.connect.swiftcoderZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.swiftcoderZen.visit.prefix": "다음 ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  "provider.connect.oauth.code.visit.prefix": "다음 ",
  "provider.connect.oauth.code.visit.link": "이 링크",
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 SwiftCoder에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 SwiftCoder에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "swiftcoder.json에 구성된 플러그인",
  ...
  "dialog.server.title": "에이전트 실행 환경",
  "dialog.server.description": "SwiftCoder Agent Runtime을 실행할 위치를 선택합니다.",
  "dialog.server.search.placeholder": "실행 환경 검색",
  "dialog.server.empty": "원격 환경 없음",
  "dialog.server.add.title": "원격 환경 추가",
  "dialog.server.add.url": "원격 환경 URL",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Agent Runtime에 연결할 수 없습니다",
  "dialog.server.add.checking": "확인 중...",
  "dialog.server.add.button": "원격 환경 추가",
  "dialog.server.add.name": "환경 이름 (선택 사항)",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "사용자 이름 (선택 사항)",
  "dialog.server.add.password": "비밀번호 (선택 사항)",
  "dialog.server.edit.title": "원격 환경 편집",
  "dialog.server.default.title": "기본 실행 환경",
  "dialog.server.default.description":
    "이 Mac에서 Agent Runtime을 시작하는 대신 앱 실행 시 이 원격 환경에 연결합니다. 다시 시작해야 합니다.",
  "dialog.server.default.none": "선택된 원격 환경 없음",
  "dialog.server.default.set": "현재 환경을 기본값으로 설정",
  "dialog.server.default.clear": "지우기",
  "dialog.server.action.remove": "환경 제거",
  ...
  "toast.update.description": "SwiftCoder의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 SwiftCoder 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(swiftcoder.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: SwiftCoder는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "status.popover.tab.servers": "에이전트 실행 환경",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "SwiftCoder 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 SwiftCoder가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "SwiftCoder가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "SwiftCoder 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "SwiftCoder를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 SwiftCoder를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder 확인 중...",
  "wsl.onboarding.checkingSwiftCoderIn": "{{distro}}에서 SwiftCoder 확인 중...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder 업데이트 중...",
  "wsl.onboarding.updatingSwiftCoderIn": "{{distro}}에서 SwiftCoder 업데이트 중...",
  "wsl.onboarding.updateSwiftCoderIn": "{{distro}}에서 SwiftCoder를 업데이트하세요.",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder 업데이트",
  "wsl.onboarding.swiftcoderReadyIn": "{{distro}}에서 SwiftCoder를 사용할 준비가 되었습니다.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder가 준비되었습니다.",
  "wsl.onboarding.installSwiftCoderIn": "{{distro}}에 SwiftCoder를 설치하세요.",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder 설치",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SwiftCoder에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 SwiftCoder를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 SwiftCoder Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "SwiftCoder를 불러오지 못했습니다",
  "desktop.recovery.terminated": "SwiftCoder 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "SwiftCoder가 응답하지 않습니다",
  ...
  "desktop.server.local": "로컬 에이전트 실행 환경",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder 설치 실패",
  "desktop.wsl.error.alreadyAdded": "{{distro}} 배포판은 이미 추가되었습니다",
  "desktop.wsl.error.swiftcoderMissing": "이 배포판에 swiftcoder가 설치되어 있지 않습니다",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.swiftcoderNotInstalled": "{{distro}}에 SwiftCoder가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
