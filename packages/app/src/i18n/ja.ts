export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoderを読み込めませんでした",
  "desktop.recovery.terminated": "SwiftCoderのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "SwiftCoderが応答していません",
  ...
  "desktop.server.local": "ローカルエージェント実行環境",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoderのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.swiftcoderMissing": "このディストリビューションにはswiftcoderがインストールされていません",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoderはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.swiftcoderNotInstalled": "{{distro}}にはSwiftCoderがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "SwiftCoderのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.swiftcoder.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.swiftcoder.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.swiftcoderGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoderが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、SwiftCoderで{{provider}}モデルを使用します。",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoderは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.swiftcoderZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.swiftcoderZen.visit.prefix": " ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してSwiftCoderで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、SwiftCoderで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "swiftcoder.jsonで設定されたプラグイン",
  ...
  "dialog.server.title": "エージェント実行環境",
  "dialog.server.description": "SwiftCoder Agent Runtimeの実行場所を選択します。",
  "dialog.server.search.placeholder": "実行環境を検索",
  "dialog.server.empty": "リモート環境はまだありません",
  "dialog.server.add.title": "リモート環境を追加",
  "dialog.server.add.url": "リモート環境URL",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Agent Runtimeに接続できませんでした",
  "dialog.server.add.checking": "確認中...",
  "dialog.server.add.button": "リモート環境を追加",
  "dialog.server.add.name": "環境名 (オプション)",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "ユーザー名 (オプション)",
  "dialog.server.add.password": "パスワード (オプション)",
  "dialog.server.edit.title": "リモート環境を編集",
  "dialog.server.default.title": "デフォルト実行環境",
  "dialog.server.default.description":
    "このMacでAgent Runtimeを起動する代わりに、アプリ起動時にこのリモート環境へ接続します。再起動が必要です。",
  "dialog.server.default.none": "リモート環境が選択されていません",
  "dialog.server.default.set": "現在の環境をデフォルトに設定",
  "dialog.server.default.clear": "クリア",
  "dialog.server.action.remove": "環境を削除",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoderを確認中...",
  "wsl.onboarding.checkingSwiftCoderIn": "{{distro}}内のSwiftCoderを確認中...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoderを更新中...",
  "wsl.onboarding.updatingSwiftCoderIn": "{{distro}}内のSwiftCoderを更新中...",
  "wsl.onboarding.updateSwiftCoderIn": "{{distro}}内のSwiftCoderを更新してください。",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoderを更新",
  "wsl.onboarding.swiftcoderReadyIn": "{{distro}}内のSwiftCoderの準備ができました。",
  "wsl.onboarding.swiftcoderReady": "SwiftCoderの準備ができました。",
  "wsl.onboarding.installSwiftCoderIn": "{{distro}}にSwiftCoderをインストールしてください。",
  "wsl.onboarding.installSwiftCoder": "SwiftCoderをインストール",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoderがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SwiftCoderでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、SwiftCoderをもう一度開いてください。",
  ...
  "help.tabs.introduction": "SwiftCoder Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoderの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをSwiftCoderチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (swiftcoder.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: SwiftCoderはまだMCP認証をサポートしていません。',
  ...
  "status.popover.tab.servers": "エージェント実行環境",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoderには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "SwiftCoderの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのSwiftCoderの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "SwiftCoderがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "SwiftCoderのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "SwiftCoder の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "SwiftCoder は最新バージョンです。",
