...
export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder-meny",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder kunne ikke lastes inn",
  "desktop.recovery.terminated": "SwiftCoder-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "SwiftCoder svarer ikke",
  ...
  "desktop.wsl.error.installSwiftCoder": "Installasjonen av SwiftCoder mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder er ikke installert i denne distribusjonen",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder er installert, men kunne ikke kjøres",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av SwiftCoder er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.swiftcoder.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.swiftcoderGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Besøk ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i SwiftCoder.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i swiftcoder.json",
  ...
  "dialog.server.description": "Bytt hvilken SwiftCoder-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av SwiftCoder ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til SwiftCoder-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (swiftcoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at SwiftCoder ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør SwiftCoder-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for SwiftCoder",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan SwiftCoder ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om SwiftCoder skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når SwiftCoder starter",
  ...
  "settings.updates.toast.latest.title": "SwiftCoder er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av SwiftCoder.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Sjekker SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Sjekker SwiftCoder i {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Oppdaterer SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Oppdaterer SwiftCoder i {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Oppdater SwiftCoder i {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Oppdater SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder er klar i {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder er klar.",
  "wsl.onboarding.installSwiftCoderIn": "Installer SwiftCoder i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før SwiftCoder kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter SwiftCoder på nytt.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
