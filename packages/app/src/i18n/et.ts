export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder laadimine ebaõnnestus",
  "desktop.recovery.terminated": "SwiftCoder aken suleti ootamatult",
  "desktop.recovery.unresponsive": "SwiftCoder ei vasta",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder pole sellesse distrosse installitud",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.swiftcoder.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.swiftcoderGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid SwiftCoder'is.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Külastage ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises SwiftCoder.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis swiftcoder.json",
  ...
  "dialog.server.description": "Lülitage, millise SwiftCoder serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder kontrollimine...",
  "wsl.onboarding.checkingSwiftCoderIn": "SwiftCoder kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder värskendamine...",
  "wsl.onboarding.updatingSwiftCoderIn": "SwiftCoder värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Värskenda SwiftCoder jaotises {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Värskenda SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder on valmis {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder on valmis.",
  "wsl.onboarding.installSwiftCoderIn": "Installige SwiftCoder asukohta {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Installige SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui SwiftCoder saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse SwiftCoder ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast SwiftCoder meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (swiftcoder.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, SwiftCoder ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "settings.desktop.wsl.description": "Käivitage SwiftCoder server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke SwiftCoder kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas SwiftCoder teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas SwiftCoder järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas SwiftCoder on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui SwiftCoder käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse SwiftCoder uusimat versiooni.",
