export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.swiftcoder.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.swiftcoderGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCodern tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja SwiftCoderssa.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Avaa ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja SwiftCoderssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja SwiftCoderssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään swiftcoder.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda SwiftCoder-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Tarkistetaan SwiftCodera...",
  "wsl.onboarding.checkingSwiftCoderIn": "Tarkistetaan SwiftCodera kohteessa {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Päivitetään SwiftCodera...",
  "wsl.onboarding.updatingSwiftCoderIn": "Päivitetään SwiftCodera kohteessa {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Päivitä SwiftCoder jakelussa {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Päivitä SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder on valmis jakelussa {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder on valmis.",
  "wsl.onboarding.installSwiftCoderIn": "Asenna SwiftCoder jakeluun {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Asenna SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCodera ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin SwiftCoder voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten SwiftCoder uudelleen.",
  ...
  "toast.update.description": "SwiftCodern uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä SwiftCoder-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (swiftcoder.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että SwiftCoder ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita SwiftCoder-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda SwiftCodern näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä SwiftCoder näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö SwiftCoder järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta SwiftCodern teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun SwiftCoder käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät SwiftCodern uusinta versiota.",
  ...
  "desktop.menu.documentation": "SwiftCoder-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder-valikko",
  ...
  "desktop.recovery.loadFailed": "SwiftCodern lataaminen epäonnistui",
  "desktop.recovery.terminated": "SwiftCoder-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "SwiftCoder ei vastaa",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCodern asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.swiftcoderMissing": "swiftcodera ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCodera ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCodern päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
