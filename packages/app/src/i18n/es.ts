export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de SwiftCoder",
  ...
  "desktop.menu.ariaLabel": "Menú de SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar SwiftCoder",
  "desktop.recovery.terminated": "La ventana de SwiftCoder se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "SwiftCoder no responde",
  ...
  "desktop.server.local": "Entorno local del agente",
  ...
  "desktop.wsl.error.installSwiftCoder": "No se pudo instalar SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder no está instalado en esta distribución",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de SwiftCoder finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.swiftcoder.tagline": "Modelos optimizados y fiables",
  "dialog.provider.swiftcoderGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.swiftcoderZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.swiftcoderZen.visit.prefix": "Visita ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en SwiftCoder.",
  ...
  "dialog.plugins.empty": "Plugins configurados en swiftcoder.json",
  ...
  "dialog.server.title": "Entornos del agente",
  "dialog.server.description": "Elige dónde se ejecuta SwiftCoder Agent Runtime.",
  "dialog.server.search.placeholder": "Buscar entornos",
  "dialog.server.empty": "Aún no hay entornos remotos",
  "dialog.server.add.title": "Añadir entorno remoto",
  "dialog.server.add.url": "URL del entorno remoto",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "No se pudo conectar a Agent Runtime",
  "dialog.server.add.checking": "Comprobando...",
  "dialog.server.add.button": "Añadir entorno remoto",
  "dialog.server.add.name": "Nombre del entorno (opcional)",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "Nombre de usuario (opcional)",
  "dialog.server.add.password": "Contraseña (opcional)",
  "dialog.server.edit.title": "Editar entorno remoto",
  "dialog.server.default.title": "Entorno predeterminado",
  "dialog.server.default.description":
    "Conectar a este entorno remoto al iniciar la aplicación en lugar de iniciar Agent Runtime en este Mac. Requiere reiniciar.",
  "dialog.server.default.none": "Ningún entorno remoto seleccionado",
  "dialog.server.default.set": "Establecer el entorno actual como predeterminado",
  "dialog.server.default.clear": "Limpiar",
  "dialog.server.action.remove": "Eliminar entorno",
  ...
  "dialog.server.current": "Entorno actual",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Comprobando SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Comprobando SwiftCoder en {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Actualizando SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Actualizando SwiftCoder en {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Actualiza SwiftCoder en {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Actualizar SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder está listo en {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder está listo.",
  "wsl.onboarding.installSwiftCoderIn": "Instala SwiftCoder en {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instalar SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que SwiftCoder pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de SwiftCoder ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de SwiftCoder",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (swiftcoder.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: SwiftCoder aún no admite la autenticación MCP.',
  ...
  "status.popover.tab.servers": "Entornos del agente",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.tab.agentEnvironments": "Entornos",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integración con WSL",
  "settings.desktop.wsl.description": "Ejecutar el servidor SwiftCoder dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve SwiftCoder en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si SwiftCoder sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de SwiftCoder.",
