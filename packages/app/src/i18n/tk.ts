export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Resminamalar",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder menýusy",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder ýükläp bilmedi",
  "desktop.recovery.terminated": "SwiftCoder penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "SwiftCoder jogap berenok",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.swiftcoderMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.swiftcoder.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.swiftcoderGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we SwiftCoder-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Sapar ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini SwiftCoder-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini SwiftCoder-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "swiftcoder.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy SwiftCoder serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder barlamak ...",
  "wsl.onboarding.checkingSwiftCoderIn": "{{distro}} içinde SwiftCoder barlanýar...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder täzelenmek ...",
  "wsl.onboarding.updatingSwiftCoderIn": "{{distro}}-de SwiftCoder täzelenmek ...",
  "wsl.onboarding.updateSwiftCoderIn": "SwiftCoder-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder täzeläň",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder {{distro}}-de taýýar.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder taýýar.",
  "wsl.onboarding.installSwiftCoderIn": "{{distro}}-de SwiftCoder guruň.",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder guruň",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) SwiftCoder WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra SwiftCoder açyň.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin SwiftCoder ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy SwiftCoder toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (swiftcoder.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, SwiftCoder entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "SwiftCoder serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "SwiftCoder üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "SwiftCoder enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "SwiftCoder ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "SwiftCoder-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "SwiftCoder işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "SwiftCoder-iň iň soňky wersiýasyny işleýärsiňiz.",
