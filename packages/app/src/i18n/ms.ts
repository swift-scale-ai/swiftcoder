export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap SwiftCoder ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "SwiftCoder tidak memberi respons",
  ...
  "desktop.wsl.error.installSwiftCoder": "Pemasangan SwiftCoder gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder tidak dipasang dalam distro ini",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini SwiftCoder selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.swiftcoder.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.swiftcoderGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Layari",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam SwiftCoder.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam swiftcoder.json",
  ...
  "dialog.server.description": "Tukar pelayan SwiftCoder yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Sedang menyemak SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Sedang menyemak SwiftCoder dalam {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Sedang mengemas kini SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Sedang mengemas kini SwiftCoder dalam {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Kemas kini SwiftCoder dalam {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Kemas kini SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder sedia digunakan.",
  "wsl.onboarding.installSwiftCoderIn": "Pasang SwiftCoder dalam {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Pasang SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum SwiftCoder boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu SwiftCoder ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan SwiftCoder",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (swiftcoder.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, SwiftCoder belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan SwiftCoder dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa SwiftCoder pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada SwiftCoder mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila SwiftCoder dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini SwiftCoder.",
