export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać SwiftCoder",
  "desktop.recovery.terminated": "Okno SwiftCoder zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "SwiftCoder nie odpowiada",
  ...
  "desktop.wsl.error.installSwiftCoder": "Nie udało się zainstalować SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.swiftcoderMissing": "Program swiftcoder nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.swiftcoderCannotRun": "Program swiftcoder jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja SwiftCoder została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.swiftcoder.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.swiftcoderGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Odwiedź ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w SwiftCoder.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku swiftcoder.json",
  ...
  "dialog.server.description": "Przełącz serwer SwiftCoder, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Sprawdzanie SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Sprawdzanie SwiftCoder w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Aktualizowanie SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Aktualizowanie SwiftCoder w dystrybucji {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Zaktualizuj SwiftCoder w dystrybucji {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Zaktualizuj SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder jest gotowy.",
  "wsl.onboarding.installSwiftCoderIn": "Zainstaluj SwiftCoder w dystrybucji {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Zainstaluj SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim SwiftCoder będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja SwiftCoder ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu SwiftCoder",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (swiftcoder.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: SwiftCoder nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer SwiftCoder wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd SwiftCoder na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy SwiftCoder ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji SwiftCoder.",
