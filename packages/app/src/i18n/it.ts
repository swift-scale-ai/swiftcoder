export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.swiftcoder.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.swiftcoderGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.swiftcoderZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in SwiftCoder.",
  ...
  "dialog.plugins.empty": "Plugin configurati in swiftcoder.json",
  ...
  "dialog.server.description": "Cambia il server SwiftCoder a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Controllo SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Controllo SwiftCoder in {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Aggiornamento SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Aggiornamento SwiftCoder in {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Aggiorna SwiftCoder in {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Aggiorna SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder è pronto in {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder è pronto.",
  "wsl.onboarding.installSwiftCoderIn": "Installa SwiftCoder in {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Installa SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che SwiftCoder possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di SwiftCoder ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team SwiftCoder",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (swiftcoder.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: SwiftCoder non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server SwiftCoder all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di SwiftCoder sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se SwiftCoder segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di SwiftCoder",
  ...
  "settings.updates.toast.latest.title": "SwiftCoder è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di SwiftCoder.",
  ...
  "desktop.menu.documentation": "Documentazione di SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare SwiftCoder",
  "desktop.recovery.terminated": "La finestra di SwiftCoder si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "SwiftCoder non risponde",
  ...
  "desktop.wsl.error.installSwiftCoder": "Installazione di SwiftCoder non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder non è installato in questa distribuzione",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di SwiftCoder è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
