export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder yüklənə bilmədi",
  "desktop.recovery.terminated": "SwiftCoder pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "SwiftCoder cavab vermir",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.swiftcoderMissing": "Bu distribütivdə swiftcoder quraşdırılmayıb",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.swiftcoder.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.swiftcoderGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "SwiftCoder tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və SwiftCoder-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və SwiftCoder-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və SwiftCoder-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər swiftcoder.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu SwiftCoder serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "SwiftCoder yoxlanılır...",
  "wsl.onboarding.checkingSwiftCoderIn": "{{distro}}-də SwiftCoder yoxlanılır...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder yenilənir...",
  "wsl.onboarding.updatingSwiftCoderIn": "{{distro}}-də SwiftCoder yenilənir...",
  "wsl.onboarding.updateSwiftCoderIn": "{{distro}}-də SwiftCoder-u yeniləyin.",
  "wsl.onboarding.updateSwiftCoder": "SwiftCoder-u yeniləyin",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder {{distro}}-də hazırdır.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder hazırdır.",
  "wsl.onboarding.installSwiftCoderIn": "SwiftCoder-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installSwiftCoder": "SwiftCoder quraşdırın",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "SwiftCoder WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra SwiftCoder-u yenidən açın.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "SwiftCoder-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı SwiftCoder komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (swiftcoder.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: SwiftCoder hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində SwiftCoder serverini işlət.",
  ...
  "settings.general.row.language.description": "SwiftCoder üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "SwiftCoder-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "SwiftCoder-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "SwiftCoder-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "SwiftCoder açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "SwiftCoder-un ən son versiyasından istifadə edirsiniz.",
