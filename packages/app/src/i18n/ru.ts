export const dict = {
  ...
  "desktop.menu.documentation": "Документация SwiftCoder",
  ...
  "desktop.menu.ariaLabel": "Меню SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить SwiftCoder",
  "desktop.recovery.terminated": "Окно SwiftCoder неожиданно завершило работу",
  "desktop.recovery.unresponsive": "SwiftCoder не отвечает",
  ...
  "desktop.server.local": "Локальная среда агента",
  ...
  "desktop.wsl.error.installSwiftCoder": "Не удалось установить SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder не установлен в этом дистрибутиве",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder установлен, но его не удалось запустить",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление SwiftCoder завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.swiftcoder.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.swiftcoderGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Посетите ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": ", чтобы получить ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в SwiftCoder.",
  ...
  "dialog.plugins.empty": "Плагины настроены в swiftcoder.json",
  ...
  "dialog.server.title": "Среды агента",
  "dialog.server.description": "Выберите, где будет работать SwiftCoder Agent Runtime.",
  "dialog.server.search.placeholder": "Поиск сред",
  "dialog.server.empty": "Удалённых сред пока нет",
  "dialog.server.add.title": "Добавить удалённую среду",
  "dialog.server.add.url": "URL удалённой среды",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Не удалось подключиться к Agent Runtime",
  "dialog.server.add.checking": "Проверка...",
  "dialog.server.add.button": "Добавить удалённую среду",
  "dialog.server.add.name": "Имя среды (необязательно)",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "Имя пользователя (необязательно)",
  "dialog.server.add.password": "Пароль (необязательно)",
  "dialog.server.edit.title": "Изменить удалённую среду",
  "dialog.server.default.title": "Среда по умолчанию",
  "dialog.server.default.description":
    "Подключаться к этой удалённой среде при запуске вместо запуска Agent Runtime на этом Mac. Требуется перезапуск.",
  "dialog.server.default.none": "Удалённая среда не выбрана",
  "dialog.server.default.set": "Установить текущую среду по умолчанию",
  "dialog.server.default.clear": "Очистить",
  "dialog.server.action.remove": "Удалить среду",
  ...
  "dialog.server.current": "Текущая среда",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Проверка SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Проверка SwiftCoder в {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Обновление SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Обновление SwiftCoder в {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Обновите SwiftCoder в {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Обновить SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder в {{distro}} готов к работе.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder готов к работе.",
  "wsl.onboarding.installSwiftCoderIn": "Установите SwiftCoder в {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Установить SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в SwiftCoder требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте SwiftCoder.",
  ...
  "help.tabs.introduction": "Теперь работа в SwiftCoder Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия SwiftCoder ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде SwiftCoder",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (swiftcoder.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: SwiftCoder пока не поддерживает MCP-авторизацию.',
  ...
  "status.popover.tab.servers": "Среды агента",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид SwiftCoder на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли SwiftCoder системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию SwiftCoder.",
