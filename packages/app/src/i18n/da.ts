export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.swiftcoder.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.swiftcoderGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Besøg ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i SwiftCoder.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i swiftcoder.json",
  ...
  "dialog.server.description": "Skift hvilken SwiftCoder-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Tjekker SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Tjekker SwiftCoder i {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Opdaterer SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Opdaterer SwiftCoder i {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Opdater SwiftCoder i {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Opdater SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før SwiftCoder kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter SwiftCoder igen.",
  ...
  "toast.update.description": "En ny version af SwiftCoder ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til SwiftCoder-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (swiftcoder.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, SwiftCoder understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør SwiftCoder-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan SwiftCoder ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om SwiftCoder skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas SwiftCoders tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når SwiftCoder starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af SwiftCoder.",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder kunne ikke indlæses",
  "desktop.recovery.terminated": "SwiftCoder-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installSwiftCoder": "Installationen af SwiftCoder mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder er ikke installeret i denne distribution",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder er installeret, men kunne ikke køre",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af SwiftCoder er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
