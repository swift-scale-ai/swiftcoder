export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด SwiftCoder ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง SwiftCoder หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "SwiftCoder ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installSwiftCoder": "การติดตั้ง SwiftCoder ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.swiftcoderMissing": "ไม่ได้ติดตั้ง swiftcoder ในดิสโทรนี้",
  "desktop.wsl.error.swiftcoderCannotRun": "ติดตั้ง swiftcoder แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.swiftcoderNotInstalled": "ไม่ได้ติดตั้ง SwiftCoder ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต SwiftCoder เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.swiftcoder.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.swiftcoderGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน SwiftCoder",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน SwiftCoder",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน swiftcoder.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ SwiftCoder ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingSwiftCoder": "กำลังตรวจสอบ SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "กำลังตรวจสอบ SwiftCoder ใน {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "กำลังอัปเดต SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "กำลังอัปเดต SwiftCoder ใน {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "อัปเดต SwiftCoder ใน {{distro}}",
  "wsl.onboarding.updateSwiftCoder": "อัปเดต SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder พร้อมใช้งานแล้ว",
  "wsl.onboarding.installSwiftCoderIn": "ติดตั้ง SwiftCoder ใน {{distro}}",
  "wsl.onboarding.installSwiftCoder": "ติดตั้ง SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "ยังไม่ได้ติดตั้ง SwiftCoder",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ SwiftCoder จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด SwiftCoder อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ SwiftCoder Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ SwiftCoder ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม SwiftCoder",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (swiftcoder.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า SwiftCoder ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ SwiftCoder ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ SwiftCoder",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ SwiftCoder บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ SwiftCoder ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ SwiftCoder",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ SwiftCoder เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน SwiftCoder เวอร์ชันล่าสุด",
