export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder μενού",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "SwiftCoder το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "SwiftCoder δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.swiftcoderMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.swiftcoderCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.swiftcoder.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.swiftcoderGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο SwiftCoder.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο swiftcoder.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή SwiftCoder συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Έλεγχος SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Έλεγχος SwiftCoder σε {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Ενημέρωση SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Ενημέρωση SwiftCoder σε {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Ενημέρωση SwiftCoder σε {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Ενημέρωση SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder είναι έτοιμο.",
  "wsl.onboarding.installSwiftCoderIn": "Εγκατάσταση του SwiftCoder στο {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Εγκατάσταση SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο SwiftCoder να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του SwiftCoder ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα SwiftCoder",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (swiftcoder.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το SwiftCoder δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή SwiftCoder μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του SwiftCoder στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το SwiftCoder ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του SwiftCoder.",
