export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'SwiftCoder",
  ...
  "desktop.menu.ariaLabel": "Menu SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'SwiftCoder",
  "desktop.recovery.terminated": "La fenêtre SwiftCoder s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "SwiftCoder ne répond pas",
  ...
  "desktop.server.local": "Environnement local de l'agent",
  ...
  "desktop.wsl.error.installSwiftCoder": "Échec de l'installation d'SwiftCoder",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder n'est pas installé dans cette distribution",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'SwiftCoder est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.swiftcoder.tagline": "Modèles optimisés et fiables",
  "dialog.provider.swiftcoderGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Visitez ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans SwiftCoder.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans swiftcoder.json",
  ...
  "dialog.server.title": "Environnements de l'agent",
  "dialog.server.description": "Choisissez où s'exécute SwiftCoder Agent Runtime.",
  "dialog.server.search.placeholder": "Rechercher des environnements",
  "dialog.server.empty": "Aucun environnement distant",
  "dialog.server.add.title": "Ajouter un environnement distant",
  "dialog.server.add.url": "URL de l'environnement distant",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Impossible de se connecter à Agent Runtime",
  "dialog.server.add.checking": "Vérification...",
  "dialog.server.add.button": "Ajouter un environnement distant",
  "dialog.server.add.name": "Nom de l'environnement (optionnel)",
  "dialog.server.add.namePlaceholder": "Localhost",
  "dialog.server.add.username": "Nom d'utilisateur (optionnel)",
  "dialog.server.add.password": "Mot de passe (optionnel)",
  "dialog.server.edit.title": "Modifier l'environnement distant",
  "dialog.server.default.title": "Environnement par défaut",
  "dialog.server.default.description":
    "Se connecter à cet environnement distant au lancement au lieu de démarrer Agent Runtime sur ce Mac. Nécessite un redémarrage.",
  "dialog.server.default.none": "Aucun environnement distant sélectionné",
  "dialog.server.default.set": "Définir l'environnement actuel par défaut",
  "dialog.server.default.clear": "Effacer",
  "dialog.server.action.remove": "Supprimer l'environnement",
  ...
  "dialog.server.current": "Environnement actuel",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Vérification d'SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Vérification d'SwiftCoder dans {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Mise à jour d'SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Mise à jour d'SwiftCoder dans {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Mettez à jour SwiftCoder dans {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Mettre à jour SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder est prêt dans {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder est prêt.",
  "wsl.onboarding.installSwiftCoderIn": "Installez SwiftCoder dans {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Installer SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'SwiftCoder puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'SwiftCoder ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe SwiftCoder",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (swiftcoder.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'SwiftCoder ne prend pas encore en charge l'authentification MCP.",
  ...
  "status.popover.tab.servers": "Environnements de l'agent",
  ...
  "sidebar.gettingStarted.line1":
    "SwiftCoder inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.tab.agentEnvironments": "Environnements",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Intégration WSL",
  "settings.desktop.wsl.description": "Exécuter le serveur SwiftCoder dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'SwiftCoder sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si SwiftCoder suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'SwiftCoder.",
