...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "SwiftCoder įkelti nepavyko",
  "SwiftCoder langas netikėtai užsidarė",
  "SwiftCoder neatsako",
  ...
  "SwiftCoder įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "swiftcoder šiame distributyve neįdiegtas",
  "swiftcoder įdiegtas, bet jo paleisti nepavyko",
  "SwiftCoder neįdiegtas distributyve {{distro}}",
  "SwiftCoder naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.swiftcoder.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.swiftcoder.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.swiftcoderGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami SwiftCoder modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Aplankykite",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius SwiftCoder.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti swiftcoder.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio SwiftCoder serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Tikrinama SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Tikrinama SwiftCoder {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Atnaujinamas SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Atnaujinamas SwiftCoder {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Atnaujinkite SwiftCoder {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Atnaujinkite SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder yra paruoštas {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder yra paruoštas.",
  "wsl.onboarding.installSwiftCoderIn": "Įdiekite SwiftCoder į {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Įdiekite SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad SwiftCoder galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują SwiftCoder ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą SwiftCoder komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (swiftcoder.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad SwiftCoder dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "settings.desktop.wsl.description": "Paleiskite SwiftCoder serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite SwiftCoder ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip SwiftCoder atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar SwiftCoder seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite SwiftCoder temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią SwiftCoder versiją.",
