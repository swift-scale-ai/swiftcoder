export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za SwiftCoder",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder meni",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor SwiftCoder-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "SwiftCoder ne reaguje",
  ...
  "desktop.wsl.error.installSwiftCoder": "Instalacija SwiftCoder-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje SwiftCoder-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.swiftcoder.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.swiftcoderGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u SwiftCoder-u.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Posjeti ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u SwiftCoder-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u SwiftCoder-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u swiftcoder.json",
  ...
  "dialog.server.description": "Promijeni na koji se SwiftCoder server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Provjera SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Provjera SwiftCoder u distribuciji {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Ažuriranje SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Ažuriranje SwiftCoder u distribuciji {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Ažuriraj SwiftCoder u distribuciji {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Ažuriraj SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder je spreman.",
  "wsl.onboarding.installSwiftCoderIn": "Instaliraj SwiftCoder u distribuciji {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instaliraj SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi SwiftCoder mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija SwiftCoder-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku SwiftCoder timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (swiftcoder.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: SwiftCoder još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni SwiftCoder server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u SwiftCoder-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako SwiftCoder izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li SwiftCoder prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu SwiftCoder-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se SwiftCoder pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju SwiftCoder-a.",
