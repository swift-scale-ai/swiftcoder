...
export const dict = {
  ...
  "permission.mode.title": "How should SwiftCoder actions be approved?",
  "permission.mode.ask.title": "Ask for approval",
  "permission.mode.ask.description": "Ask before edits, commands, or internet access",
  "permission.mode.agent.title": "Approve for me",
  "permission.mode.agent.description": "Only ask when an action may be unsafe",
  "permission.mode.full.title": "Full access",
  "permission.mode.full.description": "Allow internet access and access to any file",
  ...
  "dialog.provider.swiftcoder.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.swiftcoder.tagline": "Reliable optimized models",
  "dialog.provider.swiftcoderGo.tagline": "Low cost subscription for everyone",
  "dialog.provider.anthropic.note": "Direct access to Claude models, including Pro and Max",
  "dialog.provider.openswiftscale.note": "Open-source, self-hosted OpenAI-compatible gateway",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in SwiftCoder.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.swiftcoderZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.swiftcoderZen.visit.prefix": "Visit ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in SwiftCoder.",
  ...
  "dialog.plugins.empty": "Plugins configured in swiftcoder.json",
  ...
  "dialog.server.title": "Agent environments",
  "dialog.server.description": "Choose where the SwiftCoder Agent Runtime runs.",
  "dialog.server.search.placeholder": "Search environments",
  "dialog.server.empty": "No remote environments yet",
  "dialog.server.add.title": "Add remote environment",
  "dialog.server.add.url": "Remote environment URL",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "Could not connect to Agent Runtime",
  "dialog.server.add.checking": "Checking...",
  "dialog.server.add.button": "Add remote environment",
  "dialog.server.add.name": "Environment name (optional)",
  ...
  "dialog.server.edit.title": "Edit remote environment",
  "dialog.server.default.title": "Default environment",
  "dialog.server.default.description":
    "Connect to this remote environment on app launch instead of starting Agent Runtime on this Mac. Requires restart.",
  "dialog.server.default.none": "No remote environment selected",
  "dialog.server.default.set": "Set current environment as default",
  "dialog.server.default.clear": "Clear",
  "dialog.server.action.remove": "Remove environment",
  ...
  "dialog.server.current": "Current environment",
  ...
  "wsl.onboarding.step.swiftcoder": "SwiftCoder",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Checking SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Checking SwiftCoder in {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Updating SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Updating SwiftCoder in {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Update SwiftCoder in {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Update SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder is ready in {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder is ready.",
  "wsl.onboarding.installSwiftCoderIn": "Install SwiftCoder in {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Install SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before SwiftCoder can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of SwiftCoder ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the SwiftCoder team",
  ...
  "error.chain.checkConfig": "Check your config (swiftcoder.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, SwiftCoder does not support MCP authentication yet.',
  ...
  "status.popover.tab.servers": "Agent environments",
  ...
  "sidebar.chat": "Chat",
  "sidebar.chat.empty": "No chats yet",
  "sidebar.workspaces.enable": "Enable workspaces",
  "sidebar.workspaces.disable": "Disable workspaces",
  "sidebar.gettingStarted.title": "Getting started",
  "sidebar.gettingStarted.line1": "SwiftCoder includes free models so you can start immediately.",
  ...
  "settings.account.swiftScaleAccount": "SwiftScaleCloud account",
  "settings.account.signIn.authorizing": "Complete sign in in your browser. SwiftCoder will continue automatically.",
  "settings.account.signIn.description": "Sign in to use the models included with your account.",
  "settings.account.signIn.action": "Sign in",
  "settings.account.productAccess.title": "Product access",
  "settings.account.productAccess.description": "SwiftScale products enabled for this account",
  "settings.account.plan.title": "Plan",
  "settings.account.plan.accountPayg": "{{tier}} account - Pay as you go",
  "settings.account.plan.subscription": "{{status}} subscription",
  "settings.account.plan.subscriptionWithApi": "{{subscription}} - API Services PAYG enabled",
  "settings.account.refresh": "Refresh",
  "settings.account.reset.none": "No reset date provided",
  "settings.account.reset.unavailable": "Reset date unavailable",
  "settings.account.reset.at": "Resets {{date}}",
  "settings.account.usage.title": "Usage",
  "settings.account.usage.available": "Available",
  "settings.account.usage.limited": "Limited",
  "settings.account.usage.exhausted": "Exhausted",
  "settings.account.capacity.title": "Included capacity",
  "settings.account.capacity.context": "{{tier}} context",
  "settings.account.capacity.tasks": "{{count}} concurrent tasks",
  "settings.account.capacity.unlimited": "No fixed concurrency limit",
  "settings.account.capacity.codingPlan": "Coding concurrency limit",
  "settings.account.capacity.codingDescription": "{{context}} context per task",
  "settings.account.capacity.apiServices": "API concurrency limit",
  "settings.account.capacity.apiDescription": "Maximum simultaneous tasks for this plan",
  "settings.account.context.standard": "Standard",
  "settings.account.context.extended": "Extended",
  "settings.account.context.maximum": "Maximum",
  "settings.account.subscription.active": "Active",
  "settings.account.subscription.pastDue": "Past due",
  "settings.account.subscription.canceled": "Canceled",
  "settings.account.billing.title": "Billing",
  "settings.account.billing.description": "Usage billed by tokens",
  "settings.account.billing.payg": "Pay as you go",
  "settings.account.models.title": "Model access",
  "settings.account.models.accountAccess": "Uses your signed-in account",
  "settings.account.models.catalog": "SwiftScale API catalog",
  "settings.account.service.title": "Service {{status}}",
  "settings.account.service.operational": "Operational",
  "settings.account.service.degraded": "Degraded",
  "settings.account.service.unavailable": "Unavailable",
  "settings.account.service.requestId": "Request ID: {{requestId}}",
  "settings.account.service.status": "Status",
  "settings.account.service.support": "Support",
  "settings.account.actions.title": "Account actions",
  "settings.account.actions.description": "Manage your subscription or sign out",
  "settings.account.actions.signOut": "Sign out",
  "settings.account.actions.viewPlans": "View plans",
  "settings.account.actions.manageBilling": "Manage billing",
  "settings.account.error.planDetails": "Could not load SwiftScale plan details",
  "settings.account.error.authentication": "SwiftScale authentication failed",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the SwiftCoder server inside WSL on Windows.",
  ...
  "settings.general.section.supportPrivacy": "Support and privacy",
  "settings.support.action.open": "Open",
  "settings.support.privacy.title": "Privacy policy",
  "settings.support.privacy.description": "Review how SwiftCoder and SwiftScale handle product and account data.",
  "settings.support.licenses.title": "Open-source licenses",
  "settings.support.licenses.description": "Review third-party software notices and licenses.",
  "settings.support.diagnostics.title": "Diagnostic bundle",
  "settings.support.diagnostics.description":
    "Export redacted logs from the last 24 hours. Source code and prompt content are excluded.",
  "settings.support.diagnostics.action": "Export diagnostics",
  "settings.support.diagnostics.exported.title": "Diagnostics exported",
  "settings.support.diagnostics.exported.description": "Saved to {{path}}",
  "settings.support.deleteData.title": "Delete local data",
  "settings.support.deleteData.description":
    "Remove sessions, settings, logs, caches, drafts, and SwiftScale sign-in from this Mac. Project files are kept.",
  "settings.support.deleteData.action": "Delete local data",

  "settings.general.row.language.title": "Language",
  "settings.general.row.language.description": "Change the display language for SwiftCoder",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how SwiftCoder looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether SwiftCoder follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how SwiftCoder is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when SwiftCoder launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of SwiftCoder.",
  ...
  "settings.providers.connected.accountDescription": "Connected",
