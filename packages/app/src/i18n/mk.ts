export const dict = {
  ...
  "desktop.menu.documentation": "SwiftCoder Документација",
  ...
  "desktop.menu.ariaLabel": "SwiftCoder мени",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот SwiftCoder неочекувано заврши",
  "desktop.recovery.unresponsive": "SwiftCoder не реагира",
  ...
  "desktop.wsl.error.installSwiftCoder": "инсталацијата SwiftCoder не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder е инсталиран, но не може да се изврши",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.swiftcoder.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.swiftcoderGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Посетете",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во SwiftCoder.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во swiftcoder.json",
  ...
  "dialog.server.description": "Променете на кој SwiftCoder сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Се проверува SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Се проверува SwiftCoder во {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "Се ажурира SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "Се ажурира SwiftCoder во {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Ажурирајте SwiftCoder во {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Ажурирај SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder е подготвен во {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder е подготвен.",
  "wsl.onboarding.installSwiftCoderIn": "Инсталирајте SwiftCoder во {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Инсталирај SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред SwiftCoder да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на SwiftCoder ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот SwiftCoder",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (swiftcoder.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, SwiftCoder сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот SwiftCoder во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа SwiftCoder на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали SwiftCoder ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како SwiftCoder е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на SwiftCoder.",
