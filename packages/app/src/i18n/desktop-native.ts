...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder failed to load",
  "desktop.recovery.terminated": "SwiftCoder window terminated unexpectedly",
  "desktop.recovery.unresponsive": "SwiftCoder is not responding",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoder installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.swiftcoderMissing": "swiftcoder is not installed in this distro",
  "desktop.wsl.error.swiftcoderCannotRun": "swiftcoder is installed but could not run",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
