export const dict = {
  ...
  "desktop.recovery.loadFailed": "SwiftCoder መጫን አልቻለም",
  "desktop.recovery.terminated": "SwiftCoder መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "SwiftCoder ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installSwiftCoder": "SwiftCoderመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.swiftcoderMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.swiftcoderCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "SwiftCoder ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.swiftcoder.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.swiftcoderGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በSwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በSwiftCoder ይጠቀሙ።",
  ...
  "provider.connect.swiftcoderZen.line1": "SwiftCoder ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.swiftcoderZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.swiftcoderZen.visit.prefix": "ጎብኝ ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በSwiftCoder ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በSwiftCoder ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ swiftcoder.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው SwiftCoder አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingSwiftCoder": "መፈተሽ SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "SwiftCoderን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingSwiftCoder": "በማዘመን ላይ SwiftCoder...",
  "wsl.onboarding.updatingSwiftCoderIn": "በማዘመን ላይ SwiftCoder በ{{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "አዘምን SwiftCoder በ{{distro}}።",
  "wsl.onboarding.updateSwiftCoder": "አዘምን SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder ዝግጁ ነው።",
  "wsl.onboarding.installSwiftCoderIn": "መጫን SwiftCoder በ{{distro}} ውስጥ።",
  "wsl.onboarding.installSwiftCoder": "ጫን SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoderአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) SwiftCoder WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ SwiftCoder።",
  ...
  "help.tabs.introduction": "SwiftCoder ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የSwiftCoder ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለSwiftCoder ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (swiftcoder.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ SwiftCoder እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የSwiftCoder አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለSwiftCoder",
  ...
  "settings.general.row.appearance.description": "SwiftCoderበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "SwiftCoder ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "SwiftCoder ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "SwiftCoder ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የSwiftCoder እትም እያሄዱ ነው።",
