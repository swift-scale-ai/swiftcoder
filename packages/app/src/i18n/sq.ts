export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni SwiftCoder",
  ...
  "desktop.menu.ariaLabel": "Menuja SwiftCoder",
  ...
  "desktop.recovery.loadFailed": "SwiftCoder nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja SwiftCoder u mbyll papritur",
  "desktop.recovery.unresponsive": "SwiftCoder nuk po përgjigjet",
  ...
  "desktop.wsl.error.installSwiftCoder": "Instalimi i SwiftCoder dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.swiftcoderMissing": "SwiftCoder nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.swiftcoderCannotRun": "SwiftCoder është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.swiftcoderNotInstalled": "SwiftCoder nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i SwiftCoder përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.swiftcoder.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.swiftcoder.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.swiftcoderGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga SwiftCoder",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në SwiftCoder.",
  ...
  "provider.connect.swiftcoderZen.line1":
    "SwiftCoder ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.swiftcoderZen.visit.prefix": "Vizitoni ",
  "provider.connect.swiftcoderZen.visit.link": "swift-scale.com/account/api-keys",
  "provider.connect.swiftcoderZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në SwiftCoder.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në SwiftCoder.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në swiftcoder.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server SwiftCoder lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingSwiftCoder": "Po kontrollon SwiftCoder...",
  "wsl.onboarding.checkingSwiftCoderIn": "Po kontrollon SwiftCoder në {{distro}}...",
  "wsl.onboarding.updatingSwiftCoder": "SwiftCoder po përditësohet...",
  "wsl.onboarding.updatingSwiftCoderIn": "Po përditëson SwiftCoder në {{distro}}...",
  "wsl.onboarding.updateSwiftCoderIn": "Përditëso SwiftCoder në {{distro}}.",
  "wsl.onboarding.updateSwiftCoder": "Përditëso SwiftCoder",
  "wsl.onboarding.swiftcoderReadyIn": "SwiftCoder është gati në {{distro}}.",
  "wsl.onboarding.swiftcoderReady": "SwiftCoder është gati.",
  "wsl.onboarding.installSwiftCoderIn": "Instaloni SwiftCoder në {{distro}}.",
  "wsl.onboarding.installSwiftCoder": "Instaloni SwiftCoder",
  ...
  "wsl.onboarding.distroStatus.swiftcoderMissing": "SwiftCoder nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se SwiftCoder të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "SwiftCoder nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap SwiftCoder.",
  ...
  "help.tabs.introduction": "SwiftCoder Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i SwiftCoder ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i SwiftCoder",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (swiftcoder.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, SwiftCoder nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "SwiftCoder përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin SwiftCoder brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për SwiftCoder",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket SwiftCoder në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse SwiftCoder ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e SwiftCoder.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset SwiftCoder",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të SwiftCoder.",
