...
beforeAll(async () => {
  ...
  mock.module("@swiftscale/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@swiftscale/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@swiftscale/ui/icon", () => ({ Icon: () => null }))
  mock.module("@swiftscale/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
