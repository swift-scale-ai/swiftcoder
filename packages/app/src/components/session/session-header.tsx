import { AppIcon } from "@swiftscale/ui/app-icon"
...
import { Keybind } from "@swiftscale/ui/keybind"
...
import { KeybindV2 } from "@swiftscale/ui/v2/keybind-v2"
...
export function SessionHeader() {
  ...
  const v2ActionsState = createMemo<SessionHeaderV2ActionsState>(() => ({
    ...
    terminalLabel: language.t("command.terminal.new"),
    terminalKeybind: command.keybindParts("terminal.new"),
    terminalVisible: isDesktop(),
    terminalOpened: view().terminal.opened(),
    onTerminalToggle: openNewTerminal,
  ...
  onMount(() => {
    setCenterMount(document.getElementById("swiftcoder-titlebar-center"))
  })
