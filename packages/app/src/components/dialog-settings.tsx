...
import { SwiftScaleAccountSettings } from "./dialog-swiftscale-account"
...
export const DialogSettings: Component<{ defaultValue?: string }> = (props) => {
  ...
  return (
    <Dialog size="x-large" transition floatingClose>
      <Tabs orientation="vertical" variant="settings" value={tab()} onChange={setTab} class="h-full settings-dialog">
        <Tabs.List>
          <div class="flex flex-col justify-between h-full w-full gap-4">
            <div class="flex flex-col gap-3 w-full pt-3">
              <div class="flex flex-col gap-3">
                <div class="flex flex-col gap-1.5">
                  <Tabs.SectionTitle>{language.t("settings.section.swiftscale")}</Tabs.SectionTitle>
            ...
            <div class="flex items-center gap-1 pl-1 py-1 text-12-medium text-text-weak">
