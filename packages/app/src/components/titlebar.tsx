...
import { Tooltip, TooltipKeybind } from "@swiftscale/ui/tooltip"
...
export function useTitlebarRightMount() {
  ...
  const sync = () => setMount(document.getElementById("swiftcoder-titlebar-right"))
  onMount(sync)
        ...
        <Match when={useV2Titlebar()}>
          {(_) => {
            ...
            return (
              ...
              >
                <span
                  data-slot="swiftcoder-brand-title"
                  class="pointer-events-none absolute inset-0 flex items-center justify-center text-11-medium text-text-base"
                >
                  SwiftCoder
                </span>
          ...
          >
            ...
            >
                ...
                <div
                  class={
                    platform.platform === "desktop"
                      ? "hidden"
                      : "sm:hidden w-10 shrink-0 flex items-center justify-center"
                  }
                >
                  <IconButton
                    icon="menu"
              ...
              <Show when={!mac()}>
                <div
                  class={
                    platform.platform === "desktop"
                      ? "hidden"
                      : "sm:hidden w-[48px] shrink-0 flex items-center justify-center"
                  }
                >
                  <IconButton
                    icon="menu"
              ...
              <div class="flex items-center gap-1 shrink-0">
                <TooltipKeybind
                  class={web() ? "hidden sm:flex shrink-0 ml-14" : "flex shrink-0 ml-2"}
                  placement="bottom"
                ...
                <div class={web() ? "hidden sm:flex items-center shrink-0" : "flex items-center shrink-0"}>
                  ...
                  >
                    ...
                    <div id="swiftcoder-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                  </div>
                </div>
                <ChannelIndicator debugTools={props.debugTools} />
              </div>
            ...
            <div
              ...
              data-tauri-drag-region
            >
              <div id="swiftcoder-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="swiftcoder-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator(props: { debugTools?: { visible: boolean; toggle: () => void } }) {
  const channel = import.meta.env.VITE_SWIFTCODER_CHANNEL
