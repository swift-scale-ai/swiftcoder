  ...
  return (
    ...
    >
      <div class="w-2/3 max-w-3xl flex flex-col items-center justify-center gap-8">
        <div class="flex shrink-0 items-center gap-3 text-text-strong">
          <img
            src="./swiftcoder-logo-128.png"
            srcset="./swiftcoder-logo-256.png 2x"
            width="64"
            height="64"
            alt=""
            class="size-16 rounded-lg object-cover opacity-80"
          />
          <span class="text-2xl font-medium">SwiftCoder</span>
        </div>
        ...
        <div class="flex flex-col items-center gap-2">
          <div class="flex items-center justify-center gap-1">
            ...
            <button
              ...
              onClick={() => platform.openExternal("https://swift-scale.com/desktop-feedback")}
            >
