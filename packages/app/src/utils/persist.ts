...
const GLOBAL_STORAGE = "swiftcoder.global.dat"
const WINDOW_STORAGE = "swiftcoder.window"
const LOCAL_PREFIX = "swiftcoder."
...
function workspaceStorage(dir: string) {
  ...
  return `swiftcoder.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `swiftcoder.draft.${head}.${sum}.dat`
}
