...
export const dict = {
  ...
  "ui.sessionTurn.retry.rateLimited": "当前请求较多，SwiftCoder 将自动重试。",
  ...
  "dialog.usageExceeded.freeTier.description": "订阅 SwiftCoder，可靠地使用最佳开源模型，每月 $5 起。",
  ...
  "ui.permission.allowAlways": "本会话始终允许",
