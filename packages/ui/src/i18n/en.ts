export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.retry.rateLimited": "Too many requests right now. SwiftCoder will retry automatically.",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to SwiftCoder for reliable access to the best open-source models, starting at $5/month.",
  ...
  "ui.permission.allowAlways": "Always allow in this session",
