export const dict = {
  ...
  "ui.sessionTurn.retry.rateLimited": "Il y a trop de demandes pour le moment. SwiftCoder réessaiera automatiquement.",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonnez-vous à SwiftCoder pour un accès fiable aux meilleurs modèles à code source ouvert, à partir de 5 $ US par mois.",
