export const dict = {
  ...
  "ui.sessionTurn.retry.rateLimited": "Há muitas solicitações no momento. O SwiftCoder tentará novamente automaticamente.",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Assine o SwiftCoder para ter acesso confiável aos melhores modelos de código aberto, a partir de $5/mês.",
