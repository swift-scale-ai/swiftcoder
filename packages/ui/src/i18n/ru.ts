export const dict = {
  ...
  "ui.sessionTurn.retry.rateLimited": "Сейчас слишком много запросов. SwiftCoder повторит попытку автоматически.",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Подпишитесь на SwiftCoder для надёжного доступа к лучшим моделям с открытым исходным кодом, от $5/месяц.",
