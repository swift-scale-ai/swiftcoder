export const dict = {
  ...
  "ui.sessionTurn.retry.rateLimited": "Hay demasiadas solicitudes en este momento. SwiftCoder volverá a intentarlo automáticamente.",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Suscríbete a SwiftCoder para acceder de forma fiable a los mejores modelos de código abierto desde 5 USD al mes.",
