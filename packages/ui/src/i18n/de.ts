...
export const dict = {
  ...
  "ui.sessionTurn.retry.rateLimited": "Zurzeit gibt es zu viele Anfragen. SwiftCoder versucht es automatisch erneut.",
  ...
  "dialog.usageExceeded.freeTier.description":
    "SwiftCoder abonnieren und zuverlässigen Zugriff auf die besten Open-Source-Modelle erhalten, ab 5 $ pro Monat.",
