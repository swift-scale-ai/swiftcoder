...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[SwiftCoder](https://swift-scale.com)")).toBe(
    '<p><a href="https://swift-scale.com" class="external-link" target="_blank" rel="noopener noreferrer">SwiftCoder</a></p>\n',
  )
})
