...
const releaseId = process.env.SWIFTCODER_RELEASE
if (!releaseId) throw new Error("SWIFTCODER_RELEASE is required")

const version = process.env.SWIFTCODER_VERSION
if (!version) throw new Error("SWIFTCODER_VERSION is required")
...
const macxTarGz = "swiftcoder-desktop-mac-x64.app.tar.gz"
const macaTarGz = "swiftcoder-desktop-mac-arm64.app.tar.gz"
