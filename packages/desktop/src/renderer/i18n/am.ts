export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የSwiftCoder ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከSwiftCoder ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
