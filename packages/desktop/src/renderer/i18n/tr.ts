export const dict = {
  ...
  "desktop.updater.none.message": "SwiftCoder'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoder'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'swiftcoder' komutunu kullanmak için terminalinizi yeniden başlatın.",
