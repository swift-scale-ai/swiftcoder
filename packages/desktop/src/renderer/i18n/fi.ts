export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo SwiftCodern uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCodern versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää SwiftCodern uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'swiftcoder'-komentoa.",
