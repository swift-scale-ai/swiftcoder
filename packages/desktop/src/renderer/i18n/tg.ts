export const dict = {
  ...
  "desktop.updater.none.message": "Шумо аллакай версияи охирини SwiftCoder-ро истифода мебаред",
  ...
  "desktop.updater.downloaded.prompt":
    "Версияи {{version}} аз SwiftCoder зеркашӣ карда шуд, оё шумо мехоҳед онро насб кунед ва аз нав оғоз кунед?",
  ...
  "desktop.cli.installed.message":
    "CLI ба {{path}} насб карда шудааст\n\nБарои истифодаи фармони 'swiftcoder' терминали худро аз нав оғоз кунед.",
