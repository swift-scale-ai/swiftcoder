export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią SwiftCoder versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoder versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
  ...
  "desktop.cli.installed.message":
    "CLI įdiegtas į {{path}}\n\nIš naujo paleiskite terminalą, kad galėtumėte naudoti komandą 'swiftcoder'.",
