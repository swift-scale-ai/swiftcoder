export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من SwiftCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من SwiftCoder. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
