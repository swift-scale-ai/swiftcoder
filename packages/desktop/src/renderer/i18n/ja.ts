export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの SwiftCoder を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoder のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'swiftcoder' コマンドを使用してください。",
