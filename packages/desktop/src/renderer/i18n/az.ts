export const dict = {
  ...
  "desktop.updater.none.message": "Artıq SwiftCoder-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoder-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'swiftcoder' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
