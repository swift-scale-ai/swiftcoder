export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse SwiftCoder uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoder'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „swiftcoder” kasutamiseks taaskäivitage terminal.",
