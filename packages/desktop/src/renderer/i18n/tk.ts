export const dict = {
  ...
  "desktop.updater.none.message": "SwiftCoder-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoder-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'swiftcoder' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
