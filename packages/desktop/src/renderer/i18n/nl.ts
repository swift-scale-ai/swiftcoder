export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van SwiftCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van SwiftCoder is gedownload. Wil je deze installeren en SwiftCoder opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'swiftcoder' te gebruiken.",
