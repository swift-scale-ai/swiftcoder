export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք SwiftCoder-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoder-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «swiftcoder» հրամանն օգտագործելու համար:",
