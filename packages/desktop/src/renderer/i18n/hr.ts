export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju SwiftCoder",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije SwiftCoder. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI instaliran na {{path}}\n\nPonovno pokrenite terminal da biste koristili naredbu 'swiftcoder'.",
