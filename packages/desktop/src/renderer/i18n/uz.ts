export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon SwiftCoder ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "SwiftCoderning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'swiftcoder' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
