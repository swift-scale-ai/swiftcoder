export const dict = {
  ...
  "desktop.updater.none.message": "Már az SwiftCoder legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az SwiftCoder {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
  ...
  "desktop.cli.installed.message":
    "A CLI telepítési helye: {{path}}\n\nIndítsa újra a terminált az 'swiftcoder' parancs használatához.",
