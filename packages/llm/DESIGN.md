...
- Secondary audience: SwiftCoder and other durable agent runtimes
...
SwiftCoder and other durable runtimes need to own persistence, tool settlement,
...
SwiftCoder should migrate to `generateTurn` / `streamTurn`, preserving its durable
