...
import { isSessionNotFoundError, isUnauthorizedError, SwiftCoder } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = SwiftCoder.make({ baseUrl: "http://localhost:3000" })
